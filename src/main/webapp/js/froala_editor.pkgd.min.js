...
!function (e, t) {
    ...
    Element.prototype.matches || (Element.prototype.matches = Element.prototype.msMatchesSelector || Element.prototype.webkitMatchesSelector), Element.prototype.closest || (Element.prototype.closest = function (e) {
        ...
        value: function (e, t) {
            ...
            for (var n = Object(e), r = 1; r < arguments.length; r++) {
                var a = arguments[r];
                if (null != a) for (var o in a) Object.prototype.hasOwnProperty.call(a, o) && (n[o] = a[o])
            }
            return n
        }, writable: !0, configurable: !0
    }), function () {
        var i = /^\s*:scope/gi, s = /,\s*:scope/gi, l = document.createElement("div");
    ...
    $e.RegisterPlugins = function (e) {
        ...
        return {
            isBlock: l, isEmpty: function d(e, t) {
                ...
                for (; e && e.parentNode !== i.el && (!e.parentNode || !i.node.hasClass(e.parentNode, "fr-inner"));) if (l(e = e.parentNode)) return e;
                return null
        ...
        function b(e, t, n) {
            ...
            return f.opts.fullPage && (r = f.html.extractNode(e, "body") || (0 <= e.indexOf("<body") ? "" : e), n && (a = f.html.extractNode(e, "head") || "")), r = v(r, t), a && (a = v(a, t)), function i(e) {
                ...
                if (f.opts.fullPage) {
                    var r = f.html.extractDoctype(n), a = c(f.html.extractNodeAttrs(n, "html"));
                    t = null === t ? f.html.extractNode(n, "head") || "<title></title>" : t;
                    var o = c(f.html.extractNodeAttrs(n, "head")), i = c(f.html.extractNodeAttrs(n, "body"));
        ...
        function T(e) {
            ...
            !function c(e) {
                ...
                if (e.nodeType === Node.ELEMENT_NODE && $e.HTML5Map[e.tagName] && "" === f.node.attributes(e)) {
                    var t = $e.HTML5Map[e.tagName], n = "<".concat(t, ">").concat(e.innerHTML, "</").concat(t, ">");
                ...
                if (f.opts.htmlAllowComments || e.nodeType !== Node.COMMENT_NODE) if (e.tagName && e.tagName.match(p)) e.parentNode.removeChild(e); else if (e.tagName && !e.tagName.match(d)) "svg" === e.tagName ? e.parentNode.removeChild(e) : f.browser.safari && "path" === e.tagName && e.parentNode && "svg" === e.parentNode.tagName || (e.outerHTML = e.innerHTML); else {
                    ...
                    if (r) for (var a = r.length - 1; 0 <= a; a--) {
                        var o = r[a], i = o.nodeName.match(u), s = null;
            ...
            _init: function e() {
                ...
                !function s() {
                    for (var e = f.el.querySelectorAll("tr"), t = 0; t < e.length; t++) {
                        for (var n = e[t].children, r = !0, a = 0; a < n.length; a++) if ("TH" !== n[a].tagName) {
                            r = !1;
                            break
                        }
                        if (!1 !== r && 0 !== n.length) {
                ...
                !function s() {
                    ...
                    for (var e = f.el.querySelectorAll("ul, ol"), t = 0; t < e.length; t++) for (var n = f.node.contents(e[t]), r = null, a = n.length - 1; 0 <= a; a--) "LI" !== n[a].tagName && "UL" != n[a].tagName && "OL" != n[a].tagName ? (r || (r = g(f.doc.createElement("LI"))).insertBefore(n[a]), r.prepend(n[a])) : r = null
                }(), function l() {
                    var e, t, n;
                    do {
                        t = !1;
                    ...
                    for (var e = f.el.querySelectorAll("li > ul, li > ol"), t = 0; t < e.length; t++) {
                        var n = e[t];
                        if (n.nextSibling) {
                            var r = n.nextSibling, a = g(f.doc.createElement("LI"));
    ...
    $e.LinkRegExCommon = "[".concat("a-z\\u0080-\\u009f\\u00a1-\\uffff0-9-_\\.", "]{1,}"), $e.LinkRegExEnd = "((:[0-9]{1,5})|)(((\\/|\\?|#)[a-z\\u00a1-\\uffff0-9@?\\|!^=%&amp;\\/~+#-\\'*-_{}]*)|())", $e.LinkRegExTLD = "((".concat($e.LinkRegExCommon, ")(\\.(com|net|org|edu|mil|gov|co|biz|info|me|dev)))"), $e.LinkRegExHTTP = "((ftp|http|https):\\/\\/".concat($e.LinkRegExCommon, ")"), $e.LinkRegExAuth = "((ftp|http|https):\\/\\/[\\u0021-\\uffff]{1,}@".concat($e.LinkRegExCommon, ")"), $e.LinkRegExWWW = "(www\\.".concat($e.LinkRegExCommon, "\\.[a-z0-9-]{2,24})"), $e.LinkRegEx = "(".concat($e.LinkRegExTLD, "|").concat($e.LinkRegExHTTP, "|").concat($e.LinkRegExWWW, "|").concat($e.LinkRegExAuth, ")").concat($e.LinkRegExEnd), $e.LinkProtocols = ["mailto", "tel", "sms", "notes", "data"], $e.MAIL_REGEX = /.+@.+\..+/i, $e.MODULES.helpers = function (o) {
        ...
        return {
            ...
            }, isAndroid: n, isBlackberry: r, isWindowsPhone: a, isMobile: function p() {
                return n() || t() || r()
        ...
        function m(e, t, n, r, a) {
            ...
            var o = a ? l.shared.$_events : g, i = a ? l.sid : l.id,
        ...
        function v(e, t, n) {
            if (!l.edit.isDisabled() || n) {
                var r, a;
                if (0 !== e.indexOf("shared.")) r = i[e]; else {
                    if (0 < l.shared.count) return !1;
                    r = l.shared._events[e]
                }
                if (r) for (var o = 0; o < r.length; o++) if (!1 === (a = r[o].apply(l, t))) return !1;
        ...
        return {
            ...
            }, disableBlur: p, enableBlur: f, blurActive: u, focus: c, chainTrigger: function A(e, t, n) {
                if (!l.edit.isDisabled() || n) {
                    var r, a;
                    if (0 !== e.indexOf("shared.")) r = i[e]; else {
                        if (0 < l.shared.count) return !1;
                    ...
                    if (r) for (var o = 0; o < r.length; o++) void 0 !== (a = r[o].apply(l, [t])) && (t = a);
        ...
        function n(e, t) {
            if (!1 !== i.events.trigger("commands.before", s.merge([e], t || []))) {
                var n = $e.COMMANDS[e] && $e.COMMANDS[e].callback || o[e], r = !0, a = !1;
        ...
        function r(e) {
            ...
            for (var t = i.selection.blocks(), n = 0; n < t.length; n++) if ("LI" !== t[n].tagName || "LI" !== t[n].parentNode.tagName) {
                var r = s(t[n]);
        ...
        return Object.assign(c, {
            exec: n, _init: function f() {
                i.events.on("keydown", function (e) {
                    ...
                    var t = i.selection.element();
                    if (t && "HR" === t.tagName) if (e.which === $e.KEYCODE.ARROW_LEFT || e.which === $e.KEYCODE.ARROW_UP) {
        ...
        return {
            _startEnter: function E(e) {
                var t, n = v(e), r = n.nextSibling, a = n.previousSibling, o = g.html.defaultTag();
                if (g.node.isEmpty(n, !0) && r) {
                    ...
                    var c = "";
                    for (c = l.parentNode && "LI" === l.parentNode.tagName ? "".concat(s, "<li>").concat($e.MARKERS, "<br>").concat(i) : o ? "".concat(s, "<").concat(o, ">").concat($e.MARKERS, "<br></").concat(o, ">").concat(i) : "".concat(s + $e.MARKERS, "<br>").concat(i); ["UL", "OL"].indexOf(l.tagName) < 0 || l.parentNode && "LI" === l.parentNode.tagName;) l = l.parentNode;
                ...
                if (r) {
                    ...
                    if (s === g.el) return !1;
                    if (s = s.nextSibling, g.node.isBlock(s)) $e.NO_DELETE_TAGS.indexOf(s.tagName) < 0 && (m(e).replaceWith($e.MARKERS), (t = g.node.contents(n)).length && "BR" === t[t.length - 1].tagName && m(t[t.length - 1]).remove(), m(n).append(m(s).html()), m(s).remove()); else for ((t = g.node.contents(n)).length && "BR" === t[t.length - 1].tagName && m(t[t.length - 1]).remove(), m(e).replaceWith($e.MARKERS); s && !g.node.isBlock(s) && "BR" !== s.tagName;) m(n).append(m(s)), s = s.nextSibling
                }
            }
        }
        ...
        function f(e) {
            ...
            if (n = n.previousSibling, !u.node.isBlock(n) && u.node.isEditable(n)) {
                ...
                if (n.nodeType === Node.TEXT_NODE) {
                    var r = n.textContent, a = r.length;
                    ...
                    } else h(n.parentNode).after($e.MARKERS), h(n.parentNode).remove(); else h(n).after($e.MARKERS)
            ...
            } else if ($e.NO_DELETE_TAGS.indexOf(n.tagName) < 0 && (u.node.isEditable(n) || u.node.isDeletable(n))) if (u.node.isDeletable(n)) h(e).replaceWith($e.MARKERS), h(n).remove(); else if (u.node.isEmpty(n) && !u.node.isList(n)) h(n).remove(), h(e).replaceWith($e.MARKERS); else {
        ...
        function s(e) {
            ...
            if (null !== n) {
                ...
                if (u.node.isBlock(n) && (u.node.isEditable(n) || u.node.isDeletable(n)) && o && $e.NO_DELETE_TAGS.indexOf(o.tagName) < 0) if (u.node.isDeletable(o)) h(o).remove(), h(e).replaceWith($e.MARKERS); else if (u.node.isBlock(o) && u.node.isEditable(o)) if (u.node.isList(o)) if (u.node.isEmpty(n, !0)) h(n).remove(), h(o).find("li").first().prepend($e.MARKERS); else {
                    ...
                    if ((a = u.node.contents(o)).length && "BR" === a[0].tagName && h(a[0]).remove(), "BLOCKQUOTE" !== o.tagName && "BLOCKQUOTE" === n.tagName) for (a = u.node.contents(n); a.length && u.node.isBlock(a[a.length - 1]);) n = a[a.length - 1], a = u.node.contents(n); else if ("BLOCKQUOTE" === o.tagName && "BLOCKQUOTE" !== n.tagName) for (a = u.node.contents(o); a.length && u.node.isBlock(a[0]);) o = a[0], a = u.node.contents(o);
        ...
        function n(e) {
            ...
            if ("BR" === (n = n.nextSibling).tagName && u.node.isEditable(n)) if (n.nextSibling) {
                ...
                if (c(e)) u.cursorLists._del(e); else u.node.deepestParent(n) && ((!u.node.isEmpty(u.node.blockParent(n)) || (u.node.blockParent(n).nextSibling && $e.NO_DELETE_TAGS.indexOf(u.node.blockParent(n).nextSibling.tagName)) < 0) && h(n).remove(), s(e));
                return
            }
            ...
            } else if ($e.NO_DELETE_TAGS.indexOf(n.tagName) < 0 && (u.node.isEditable(n) || u.node.isDeletable(n))) if (u.node.isDeletable(n)) h(e).replaceWith($e.MARKERS), h(n).remove(); else if (u.node.isList(n)) e.previousSibling ? (h(n).find("li").first().prepend(e), u.cursorLists._backspace(e)) : (h(n).find("li").first().prepend($e.MARKERS), h(e).remove()); else if ((t = u.node.contents(n)) && "BR" === t[0].tagName && h(t[0]).remove(), t && "BLOCKQUOTE" === n.tagName) {
                var r = t[0];
        ...
        function l(e, t, n) {
            ...
            if (null === a) (r = u.html.defaultTag()) && u.node.isElement(e.parentNode) ? h(e).replaceWith("<".concat(r, ">").concat($e.MARKERS, "<br></").concat(r, ">")) : !e.previousSibling || h(e.previousSibling).is("br") || e.nextSibling ? h(e).replaceWith("<br>".concat($e.MARKERS)) : h(e).replaceWith("<br>".concat($e.MARKERS, "<br>")); else {
                var o = e, i = "";
                ...
                do {
                    if (o = o.parentNode, !t || o !== a || t && !u.node.isBlock(a)) if (l += u.node.closeTagString(o), o === a && u.node.isBlock(a)) c = d + c; else {
        ...
        function v(e, t, n) {
            ...
            if (null === r) u.html.defaultTag() && e.parentNode === u.el ? h(e).replaceWith("<".concat(u.html.defaultTag(), ">").concat($e.MARKERS, "<br></").concat(u.html.defaultTag(), ">")) : (e.nextSibling && !u.node.isBlock(e.nextSibling) || h(e).after("<br>"), h(e).replaceWith("<br>".concat($e.MARKERS))); else if (e.previousSibling && "IMG" == e.previousSibling.tagName || e.nextSibling && "IMG" == e.nextSibling.tagName) h(e).replaceWith("<" + u.html.defaultTag() + ">" + $e.MARKERS + "<br></" + u.html.defaultTag() + ">"); else {
                var a = e, o = "";
                "PRE" === r.tagName && (t = !0), u.node.isBlock(r) && !t || (o = "<br>");
                var i = "", s = "";
                do {
                    var l = a;
                    if (a = a.parentNode, "BLOCKQUOTE" === r.tagName && u.node.isEmpty(l) && !u.node.hasClass(l, "fr-marker") && h(l).contains(e) && h(l).after(e), "BLOCKQUOTE" !== r.tagName || !m(e, a) && !g(e, a)) if (!t || a !== r || t && !u.node.isBlock(r)) {
                ...
                if ("BLOCKQUOTE" === r.tagName) if (e.previousSibling && u.node.isBlock(e.previousSibling) && e.nextSibling && "BR" === e.nextSibling.tagName && (h(e.nextSibling).after(e), e.nextSibling && "BR" === e.nextSibling.tagName && h(e.nextSibling).remove()), t) o = i + o + $e.MARKERS + s; else {
        ...
        return {
            enter: function b(e) {
                ...
                0 < h(t).parentsUntil(u.$el, "BLOCKQUOTE").length && (r = !0), h(t).parentsUntil(u.$el, "TD, TH").length && (r = !1), o(t) ? !c(t) || e || r ? l(t, e, r) : u.cursorLists._endEnter(t) : i(t) ? !c(t) || e || r ? function s(e, t, n) {
                    ...
                    if (a && "BLOCKQUOTE" === a.tagName) if (g(e, a)) {
                    ...
                    if (null === a) (r = u.html.defaultTag()) && u.node.isElement(e.parentNode) ? h(e).replaceWith("<".concat(r, ">").concat($e.MARKERS, "<br></").concat(r, ">")) : h(e).replaceWith("<br>".concat($e.MARKERS)); else {
                        if (u.node.isBlock(a)) if ("PRE" === a.tagName && (t = !0), t) h(e).remove(), h(a).prepend("<br>".concat($e.MARKERS)); else if (e.nextSibling && "IMG" == e.nextSibling.tagName || e.nextSibling && e.nextSibling.nextElementSibling && "IMG" == e.nextSibling.nextElementSibling) h(e).replaceWith("<" + u.html.defaultTag() + ">" + $e.MARKERS + "<br></" + u.html.defaultTag() + ">"); else {
                ...
                }(t, e, r) : u.cursorLists._startEnter(t) : !c(t) || e || r ? v(t, e, r) : u.cursorLists._middleEnter(t), function a() {
                ...
                return o(t) ? c(t) && g(t, h(t).parents("li").first().get(0)) ? u.cursorLists._backspace(t) : e = f(t) : i(t) ? c(t) && g(t, h(t).parents("li").first().get(0)) ? u.cursorLists._backspace(t) : function l(e) {
                    ...
                    if (null !== n) {
                        ...
                        if (u.node.isBlock(n) && u.node.isEditable(n)) if (i && $e.NO_DELETE_TAGS.indexOf(i.tagName) < 0) {
                            if (u.node.isDeletable(i)) h(i).remove(), h(e).replaceWith($e.MARKERS); else if (u.node.isEditable(i)) if (u.node.isBlock(i)) if (u.node.isEmpty(i) && !u.node.isList(i)) h(i).remove(), h(e).after(u.opts.keepFormatOnDelete ? $e.INVISIBLE_SPACE : ""); else {
                                if (u.node.isList(i) && (i = h(i).find("li").last().get(0)), (o = u.node.contents(i)).length && "BR" === o[o.length - 1].tagName && h(o[o.length - 1]).remove(), "BLOCKQUOTE" === i.tagName && "BLOCKQUOTE" !== n.tagName) for (o = u.node.contents(i); o.length && u.node.isBlock(o[o.length - 1]);) i = o[o.length - 1], o = u.node.contents(i); else if ("BLOCKQUOTE" !== i.tagName && "BLOCKQUOTE" === r.tagName) for (o = u.node.contents(r); o.length && u.node.isBlock(o[0]);) r = o[0], o = u.node.contents(r);
                                if (u.node.isEmpty(n)) h(e).remove(), u.selection.setAtEnd(i, !0); else {
                ...
                if (!e) return !1;
                if (u.el.normalize(), o(e)) if (c(e)) if (0 === h(e).parents("li").first().find("ul, ol").length) u.cursorLists._del(e); else {
        ...
        function m(e) {
            for (var t = [R("9qqG-7amjlwq=="), R("KA3B3C2A6D1D5H5H1A3=="), R("3B9B3B5F3C4G3E3=="), R("QzbzvxyB2yA-9m=="), R("ji1kacwmgG5bc=="), R("nmA-13aogi1A3c1jd=="), R("BA9ggq=="), R("emznbjbH3fij=="), R("tkC-22d1qC-13sD1wzF-7=="), R("tA3jjf=="), R("1D1brkm==")], n = 0; n < t.length; n++) if (String.prototype.endsWith || (String.prototype.endsWith = function (e, t) {
        ...
        var v, b, E = f.$,
            ...
            y = function () {
                ...
                for (var t = "", n = p("charCodeAt"), r = p("fromCharCode"), a = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789".indexOf(e[0]), o = 1; o < e.length - 2; o++) {
                    for (var i = c(++a), s = e[n](o), l = ""; /[0-9-]/.test(e[o + 1]);) l += e[++o];
        ...
        function b(e, t, n) {
            if (e) {
                ...
                if (e) {
                    ...
                    if (a) {
                        if (v(a).find(".fr-marker").length || "UL" === a.tagName || "OL" === a.tagName) b(a.firstChild, t, n); else if (m.browser.mozilla && m.node.hasClass(a, "fr-marker")) {
                            var i, s = m.selection.blocks(), l = s.length;
        ...
        function E(e, t, n, r) {
            if (!r) {
                var a = !1;
                if (!0 === e.data("type")) for (; m.node.isFirstSibling(e.get(0)) && !e.parent().is(m.$el) && !e.parent().is("ol") && !e.parent().is("ul");) e.parent().before(e), a = !0; else if (!1 === e.data("type")) for (; m.node.isLastSibling(e.get(0)) && !e.parent().is(m.$el) && !e.parent().is("ol") && !e.parent().is("ul");) e.parent().after(e), a = !0;
                if (a) return !0
            }
            if (e.parents(t).length || void 0 === t) {
                var o, i = "", s = "", l = e.parent();
        ...
        function r(e, t) {
            ...
            !function d(e, t, n, r) {
                for (var a = m.node.contents(e.get(0)), o = 0; o < a.length; o++) {
                    var i = a[o];
                    if (i.innerHTML && 8203 == i.innerHTML.charCodeAt() && i.tagName.toLocaleLowerCase() == n && (i.outerHTML = i.innerHTML), m.node.hasClass(i, "fr-marker")) t = (t + 1) % 2; else if (t) if (0 < v(i).find(".fr-marker").length) t = d(v(i), t, n, r); else {
                ...
                var n = new RegExp(String.fromCharCode(8203), "g"), r = v(t), a = r.html();
        ...
        function t(e, t) {
            ...
            if (m.selection.isCollapsed()) {
                ...
                if (m.node.openTagString(l.get(0)) === '<span style="'.concat(e, ": ").concat(l.css(e), ';">')) {
                    if (m.node.isEmpty(l.get(0))) s = v(m.doc.createElement("span")).attr("style", "".concat(e, ": ").concat(t, ";")).html("".concat($e.INVISIBLE_SPACE).concat($e.MARKERS)), l.replaceWith(s); else {
                        var c = {};
        ...
        function T(e, t, n) {
            var r, a, o, i = e.parentsUntil(m.$el, "span[style]"), s = [];
        ...
        return {
            is: a, toggle: function o(e, t) {
                a(e, t) ? r(e, t) : n(e, t)
            }, apply: n, remove: r, applyStyle: t, removeStyle: function i(e) {
                t(e, null)
            }
        }
    }, $e.MODULES.spaces = function (l) {
        function r(e, t) {
            var n = e.previousSibling, r = e.nextSibling, a = e.textContent, o = e.parentNode;
        ...
        return {
            place: function p(e, t, n) {
                ...
                try {
                    ...
                    }(t, n)), !0 === t) for (o = (r = d.$el.find('span.fr-marker[data-type="true"][data-id="'.concat(n, '"]')).get(0)).nextSibling; o && o.nodeType === Node.TEXT_NODE && 0 === o.textContent.length;) f(o).remove(), o = r.nextSibling;
                    if (!0 === t && !e.collapsed) {
        ...
        function y() {
            if (A.$wp) {
                A.markers.remove();
                var e, t, n = d(), r = [];
                for (t = 0; t < n.length; t++) if (n[t].startContainer !== A.doc || A.browser.msie) {
                    var a = (e = n[t]).collapsed, o = A.markers.place(e, !0, t), i = A.markers.place(e, !1, t);
                ...
                if (A.browser.safari && r.length) for (A.selection.clear(), t = 0; t < r.length; t++) A.selection.get().addRange(r[t])
            }
        }
        ...
        function R() {
            ...
            if (A.browser.msie || A.browser.edge) for (e = 0; e < t.length; e++) t[e].style.display = "inline-block";
            A.core.hasFocus() || A.browser.msie || A.browser.webkit || A.$el.focus(), S();
            var n = T();
            for (e = 0; e < t.length; e++) {
                var r = C(t[e]).data("id"), a = t[e], o = A.doc.createRange(),
                ...
                if (0 < i.length) {
                    ...
                    try {
                        ...
                        if (a.nextSibling === i || i.nextSibling === a) {
                            ...
                            if (h && h.nodeType === Node.TEXT_NODE) for (; h && h.previousSibling && h.previousSibling.nodeType === Node.TEXT_NODE;) h.previousSibling.textContent += h.textContent, h = h.previousSibling, C(h.nextSibling).remove();
                            for (var g = u.nextSibling; g && g.nodeType === Node.TEXT_NODE && 0 === g.length;) g = (d = g).nextSibling, C(d).remove();
                            if (g && g.nodeType === Node.TEXT_NODE) for (; g && g.nextSibling && g.nextSibling.nodeType === Node.TEXT_NODE;) g.nextSibling.textContent = g.textContent + g.nextSibling.textContent, g = g.nextSibling, C(g.previousSibling).remove();
        ...
        function L(e, t, n) {
            var r, a = e.previousSibling, o = e.nextSibling;
        ...
        return {
            text: s, get: T, ranges: d, clear: S, element: function l() {
                var e = T();
                try {
                    if (e.rangeCount) {
                        var t, n = d(0), r = n.startContainer;
                        if (A.node.isElement(r) && 0 === n.startOffset && r.childNodes.length) for (; r.childNodes.length && r.childNodes[0].nodeType === Node.ELEMENT_NODE;) r = r.childNodes[0];
                ...
                return A.el
            }, save: y, restore: R, isCollapsed: w, isFull: function i() {
                if (w()) return !1;
                A.selection.save();
                ...
                for (e = 0; e < r.length; e++) for (var a = r[e]; !(t(a) || A.node.isBlock(a.parentNode) || A.$el.is(a.parentNode) || A.node.hasClass(a.parentNode, "fr-inner"));) C(a.parentNode).before(a);
                ...
                if (function E() {
                    for (var e = A.$el.find(".fr-marker"), t = 0; t < e.length; t++) if (C(e[t]).parentsUntil('.fr-element, [contenteditable="true"]', '[contenteditable="false"]').length) return !1;
                    return !0
                }()) {
                    !function T(e, t) {
                    ...
                    if (s.length) A.$el.find(".fr-marker").remove(), s.append($e.INVISIBLE_SPACE + $e.MARKERS).removeAttr("data-first"), s.attr("data-text") && s.replaceWith(s.html()); else for (A.$el.find("table").filter(function () {
                        ...
                        if (d) {
                            if (l && (!c || c !== d)) {
                                var f = A.node.blockParent(l), p = A.node.blockParent(d), u = !1, h = !1;
                                if (f && 0 <= ["UL", "OL"].indexOf(f.tagName) && (u = !(f = null)), p && 0 <= ["UL", "OL"].indexOf(p.tagName) && (h = !(p = null)), C(l).after(d), f !== p) if (null !== f || u) if (null !== p || h || 0 !== C(f).parentsUntil(A.$el, "table").length) f && p && 0 === C(f).parentsUntil(A.$el, "table").length && 0 === C(p).parentsUntil(A.$el, "table").length && !C(f).contains(p) && !C(p).contains(f) && (C(f).append(C(p).html()), C(p).remove()); else {
                ...
                var v = A.$el.find(".fr-marker").last().get(0), b = A.$el.find(".fr-marker").first().get(0);
                ...
                if (p() && r.rangeCount) {
                    var a = d();
                    for (e = 0; e < a.length; e++) {
                        var o = a[e], i = f(o.startContainer, o.startOffset), s = f(o.endContainer, o.endOffset);
                ...
                return n
            }, info: a, setAtEnd: o, setAtStart: r, setBefore: function h(e, t) {
                void 0 === t && (t = !0);
    ...
    }, Object.assign($e.DEFAULTS, {placeholderText: "Type something"}), $e.MODULES.placeholder = function (f) {
        var p = f.$;
        ...
        function e() {
            ...
            var e, t = 0, n = 0, r = 0, a = 0, o = 0, i = 0, s = 0, l = f.node.contents(f.el),
            ...
            l.length && l[0].nodeType === Node.ELEMENT_NODE ? (e = p(l[0]), (0 < f.$wp.prev().length || 0 < f.$el.prev().length) && f.ready && (t = f.helpers.getPX(e.css("margin-top")), o = f.helpers.getPX(e.css("padding-top")), n = f.helpers.getPX(e.css("margin-left")), r = f.helpers.getPX(e.css("margin-right")), i = f.helpers.getPX(e.css("padding-left")), s = f.helpers.getPX(e.css("padding-right")), a = f.helpers.getPX(e.css("margin-bottom"))), f.$placeholder.css("font-size", e.css("font-size")), f.$placeholder.css("line-height", e.css("line-height"))) : (f.$placeholder.css("font-size", f.$el.css("font-size")), f.$placeholder.css("line-height", f.$el.css("line-height"))), f.$wp.addClass("show-placeholder"), f.$placeholder.css({
                ...
                paddingBottom: f.helpers.getPX(f.$el.css("padding-bottom")) + a,
        ...
        return {
            ...
            }, show: e, hide: t, refresh: n, isVisible: function a() {
        ...
        function o(e) {
            ...
            if (e) {
                ...
                for (t = 0; t < a.length; t++) {
                    ...
                    if (o) {
                        var i = o.nextSibling, s = o.previousSibling;
            ...
            var l = u();
            for (l += ",".concat($e.VOID_ELEMENTS.join(",")), l += ", .fr-inner", l += ",".concat(N.opts.htmlAllowedEmptyTags.join(":not(.fr-marker),"), ":not(.fr-marker)"), t = r.length - 1; 0 <= t; t--) if (!(r[t].textContent && 0 < r[t].textContent.replace(/\u200B|\n/g, "").length || 0 < r[t].querySelectorAll(l).length)) {
                for (var c = N.node.contents(r[t]), d = !1, f = 0; f < c.length; f++) if (c[f].nodeType !== Node.COMMENT_NODE && c[f].textContent && 0 < c[f].textContent.replace(/\u200B|\n/g, "").length) {
                    d = !0;
                    break
                }
                d || n.push(r[t])
        ...
        function i(e, t) {
            ...
            if (t && (n = "div"), n) {
                for (var r = N.doc.createDocumentFragment(), a = null, o = !1, i = e.firstChild, s = !1; i;) {
                    var l = i.nextSibling;
                    if (i.nodeType === Node.ELEMENT_NODE && (N.node.isBlock(i) || 0 <= N.opts.htmlDoNotWrapTags.indexOf(i.tagName.toLowerCase()) && !N.node.hasClass(i, "fr-marker"))) a = null, r.appendChild(i.cloneNode(!0)); else if (i.nodeType !== Node.ELEMENT_NODE && i.nodeType !== Node.TEXT_NODE) a = null, r.appendChild(i.cloneNode(!0)); else if ("BR" === i.tagName) null === a ? (a = N.doc.createElement(n), s = !0, t && (a.setAttribute("class", "fr-temp-div"), a.setAttribute("data-empty", !0)), a.appendChild(i.cloneNode(!0)), r.appendChild(a)) : !1 === o && (a.appendChild(N.doc.createElement("br")), t && (a.setAttribute("class", "fr-temp-div"), a.setAttribute("data-empty", !0))), a = null; else {
                        var c = i.textContent;
        ...
        function n(e) {
            ...
            for (var t = N.doc.createTreeWalker(e, NodeFilter.SHOW_TEXT, N.node.filter(function (e) {
                ...
                if (!s(n.parentNode, !0)) {
                    ...
                    if (r) {
                        var o = n.previousSibling, i = n.nextSibling;
        ...
        function E(e) {
            ...
            var n, r,
                a = t ? (t.textContent.match(/\u200B/g) || []).length - t.querySelectorAll(".fr-marker").length : 0;
        ...
        return {
            defaultTag: d, isPreformatted: s, emptyBlocks: o, emptyBlockTagsQuery: function A() {
                return "".concat($e.BLOCK_TAGS.join(":empty, "), ":empty")
            }, blockTagsQuery: u, fillEmptyBlocks: function C(e) {
                var t = o(e);
            ...
            }, cleanEmptyTags: e, cleanWhiteTags: E, cleanBlankSpaces: n, blocks: function S() {
                return N.$el.get(0).querySelectorAll(u())
            }, getDoctype: x, set: function y(e) {
                var t = N.clean.html((e || "").trim(), [], [], N.opts.fullPage);
                if (N.opts.fullPage) {
                    var n = g(t, "body") || (0 <= t.indexOf("<body") ? "" : t), r = m(t, "body"),
                        a = g(t, "head") || "<title></title>", o = m(t, "head"), i = p("<div>");
                ...
                var r, a, o = [], i = {}, s = [], l = N.el.querySelectorAll("input, textarea");
                ...
                if (!N.opts.useClasses && !t) {
                    ...
                    for (r = 0; r < o.length; r++) if (o[r].getAttribute("class") && (o[r].setAttribute("fr-original-class", o[r].getAttribute("class")), o[r].removeAttribute("class")), 0 < (o[r].getAttribute("fr-original-style") || "").trim().length) {
                        var C = o[r].getAttribute("fr-original-style").split(";");
                        for (a = 0; a < C.length; a++) if (0 < C[a].indexOf(":")) {
                            var S = C[a].split(":"), y = S[0];
                            S.splice(0, 1), o[r].style[y.trim()] = S.join(":").trim()
                        }
                    }
                }
                if (N.node.isEmpty(N.el)) N.opts.fullPage && (n = x(N.iframe_document), n += "<html".concat(N.node.attributes(N.$html.get(0)), ">").concat(N.$html.find("head").get(0).outerHTML, "<body></body></html>")); else if (void 0 === e && (e = !1), N.opts.fullPage) {
                    n = x(N.iframe_document), N.$el.removeClass("fr-view");
                    var R = N.opts.heightMin, L = N.opts.height, w = N.opts.heightMax;
                ...
                }(r)), N.node.isEmpty(N.el) && !N.opts.keepFormatOnDelete && f(r)) N.el.innerHTML = r; else {
            ...
            }, checkIfEmpty: a, extractNode: g, extractNodeAttrs: m, extractDoctype: v, cleanBRs: function O() {
        ...
        IME: 229
    }, Object.assign($e.DEFAULTS, {enter: $e.ENTER_P, multiLine: !0, tabSpaces: 0}), $e.MODULES.keys = function (p) {
        var u, n, r, t = p.$, h = !1;
        ...
        function s(e) {
            ...
            h = !1;
            var r = b(n) && !m(e) && !e.altKey, a = n === $e.KEYCODE.BACKSPACE || n === $e.KEYCODE.DELETE;
        ...
        return {
            ...
            }, ctrlKey: m, isCharacter: b, isArrow: v, forceUndo: function S() {
        ...
        function t(e) {
            ...
            if (e && e.clipboardData && e.clipboardData.getData) {
                ...
                if (L.helpers.isArray(n)) for (var r = 0; r < n.length; r++) t += "".concat(n[r], ";"); else t = n;
        ...
        function a(e, t, n) {
            ...
            }(e)) && (e = L.win.localStorage.getItem("fr-copied-html")), l) e = L.clean.html(e, L.opts.pasteDeniedTags, L.opts.pasteDeniedAttrs); else {
            ...
            !t || L.wordPaste && n || (0 === (e = e.replace(/^\n*/g, "").replace(/^ /g, "")).indexOf("<colgroup>") && (e = "<table>".concat(e, "</table>")), e = N(e = function C(e) {
                ...
                for (t = 0; t < i.length; t++) {
                    var s = i[t], l = s.previousElementSibling;
                    if (l && "LI" === l.tagName) {
                ...
                var t, n = null, r = L.doc.createElement("div");
                r.innerHTML = e;
            ...
            if ("string" == typeof d && (e = d), "" !== e) {
                ...
                if (L.opts.enter === $e.ENTER_BR) for (r = (a = f.querySelectorAll("p, div")).length - 1; 0 <= r; r--) 0 === (o = a[r]).attributes.length && (o.outerHTML = o.innerHTML + (o.nextSibling && !L.node.isEmpty(o) ? "<br>" : "")); else if (L.opts.enter === $e.ENTER_DIV) for (r = (a = f.getElementsByTagName("p")).length - 1; 0 <= r; r--) 0 === (o = a[r]).attributes.length && (o.outerHTML = "<div>".concat(o.innerHTML, "</div>")); else L.opts.enter === $e.ENTER_P && 1 === f.childNodes.length && "P" === f.childNodes[0].tagName && 0 === f.childNodes[0].attributes.length && (f.childNodes[0].outerHTML = f.childNodes[0].innerHTML);
        ...
        function N(e) {
            ...
            for (var r = d(Array.prototype.slice.call(n.querySelectorAll(":scope > div:not([style]), td > div:not([style]), th > div:not([style]), li > div:not([style])"))); r.length;) {
                var a = r[r.length - 1];
                if (L.html.defaultTag() && "div" !== L.html.defaultTag()) a.querySelector(L.html.blockTagsQuery()) ? a.outerHTML = a.innerHTML : a.outerHTML = "<".concat(L.html.defaultTag(), ">").concat(a.innerHTML, "</").concat(L.html.defaultTag(), ">"); else {
            ...
            for (r = d(Array.prototype.slice.call(n.querySelectorAll("div:not([style])"))); r.length;) {
                for (t = 0; t < r.length; t++) {
                    var i = r[t], s = i.innerHTML.replace(/\u0009/gi, "").trim();
                    i.outerHTML = s
                }
        ...
        return {
            _init: function p() {
                L.el.addEventListener("copy", e), L.el.addEventListener("cut", e), L.el.addEventListener("paste", t, {capture: !0}), L.events.on("drop", r), L.browser.msie && L.browser.version < 11 && (L.events.on("mouseup", function (e) {
                    2 === e.button && (setTimeout(function () {
                        l = !1
                    }, 50), l = !0)
                }, !0), L.events.on("beforepaste", t)), L.events.on("destroy", f)
            }, cleanEmptyTagsAndDivs: N, getRtfClipboard: function u() {
                return s
            }, saveCopiedText: n, clean: a
        }
    }, Object.assign($e.DEFAULTS, {
        shortcutsEnabled: [],
        shortcutsHint: !0
        ...
        return {
            _init: function t() {
                ...
                if (!r) for (var t in r = {}, $e.SHORTCUTS_MAP) Object.prototype.hasOwnProperty.call($e.SHORTCUTS_MAP, t) && 0 <= s.opts.shortcutsEnabled.indexOf($e.SHORTCUTS_MAP[t].cmd) && (r["".concat($e.SHORTCUTS_MAP[t].cmd, ".").concat($e.SHORTCUTS_MAP[t].val || "")] = {
        ...
        function r(e, t) {
            try {
                var n = c(t.scLoc), r = t.scOffset, a = c(t.ecLoc), o = t.ecOffset, i = l.doc.createRange();
        ...
        return {
            ...
            }, dropRedo: r, reset: a, saveStep: function f(e) {
        ...
        function l(e, t) {
            var n, r = function c(e, t) {
                ...
                return n
            }(e, t), a = d(f.doc.createElement("DIV"));
            ...
            if (0 < o.length) {
                var i = f.helpers.getPX(a.find(".fr-color-set > span").css("width")),
                    s = f.helpers.getPX(o.css("paddingLeft")), l = f.helpers.getPX(o.css("paddingRight"));
        ...
        function E(r) {
            ...
            return {
                _windowResize: function () {
                    ...
                    var t = a.data("instance") || f, n = d(e.currentTarget);
                    ...
                    if (!f.core.sameInstance(a)) return !0;
                    var t = a.data("instance") || f, n = e.which;
                    if ($e.KEYCODE.ESC === n) {
                    ...
                    if (f.$wp && g(r) && a.parent().get(0) === f.$sc.get(0)) {
                        var e = a.offset().top - f.$wp.offset().top, t = f.$wp.outerHeight();
        ...
        return f.shared.exit_flag = !1, {
            ...
            }, hide: n, onHide: function S(e, t) {
                f.events.on("popups.hide.".concat(e), t)
            }, hideAll: v, setContainer: h, refresh: function y(e) {
        ...
        function s(e) {
            ...
            if (0 < r && -1 !== t) {
                var a = e.slice(r, e.length), o = (e = e.slice(0, r)).slice(0, t + 1), i = e.slice(t + 1, e.length);
                e = o;
        ...
        function n(e, t, n) {
            if (f.shared.$f_el) {
                ...
                var a = s(g(e)), o = a.index(f.shared.$f_el);
        ...
        return {
            _init: function r() {
            ...
            }, registerToolbar: a, focusToolbarElement: l, focusToolbar: u, focusContent: h, focusPopup: function y(r) {
            ...
            }, focusEditor: T, focusPopupButton: A, focusModalButton: function L(e) {
                ...
                var n = -1 !== navigator.userAgent.indexOf("Mac OS X") ? e.metaKey : e.ctrlKey, r = e.which, a = !1;
        ...
        return {
            hide: r, to: a, bind: function s(e, t, n) {
        ...
        function m(e, t) {
            var n, r = h();
            if (!e) return r;
            for (n in r = (r = r.add(l(i, e, t))).add(l(s, e, t)), g.shared.popups) if (Object.prototype.hasOwnProperty.call(g.shared.popups, n)) {
        ...
        function a(e) {
            ...
            var o = 0, i = 0, s = t.find("> .fr-dropdown-wrapper");
            if (!n) {
                var l = e.data("cmd");
                ...
                if (!g.opts.toolbarBottom && t.offset().top + e.outerHeight() + o < h(g.o_doc).height()) t.css("top", e.position().top + e.outerHeight() - c); else {
        ...
        function v(e) {
            ...
            var i = t.popup ? ' data-popup="true"' : "", s = t.modal ? ' data-modal="true"' : "",
            ...
            if ("dropdown" === t.type || "options" === t.type) {
                ...
                p += function u(e, t) {
                    ...
                    if (t.html) "function" == typeof t.html ? n += t.html.call(g) : n += t.html; else {
                        var r = t.options;
                        for (var a in "function" == typeof r && (r = r()), n += '<ul class="fr-dropdown-list" role="presentation">', r) if (Object.prototype.hasOwnProperty.call(r, a)) {
        ...
        return {
            ...
            }, build: v, buildList: function T(e, t) {
                for (var n = "", r = 0; r < e.length; r++) {
                    var a = e[r], o = $e.COMMANDS[a];
                ...
                for (var r in e) {
                    ...
                    if (a.buttons) {
                        for (var o = "", i = "", s = 0, l = "left", c = $e.TOOLBAR_VISIBLE_BUTTONS, d = 0; d < a.buttons.length; d++) {
                            var f = a.buttons[d], p = $e.COMMANDS[f];
            ...
            }, bulkRefresh: n, exec: o, click: t, hideActiveDropdowns: d, addButtons: function y(e) {
                for (var t = 0; t < e.length; t++) i.push(e)
            }, getButtons: m, getPosition: function R(e) {
        ...
        $e.ICONS[e] = t
    }, Object.assign($e.DEFAULTS, {iconsTemplate: "svg"}), $e.MODULES.icon = function (a) {
        return {
            create: function o(n) {
                var e = null, r = $e.ICONS[n];
                if (void 0 !== r) {
                ...
                var t = $e.ICONS[e], n = a.opts.iconsTemplate;
        ...
        return {
            _init: function t() {
                ...
                if (c[e]) {
                    var t = c[e], n = t.$modal, r = t.$body, a = l.o_win.innerHeight, o = n.find(".fr-modal-wrapper"),
                        i = a - o.outerHeight(!0) + (o.height() - (r.outerHeight(!0) - r.height())), s = "auto";
        ...
        function a() {
            ...
            if (0 === e.top && 0 === e.left && 0 === e.width || 0 === e.height) {
                ...
                var r = n.offset(), a = n.outerHeight();
        ...
        function o(e, t, n, r) {
            ...
            e && n.css("left", s), t && n.css("top", function c(e, t, n) {
                ...
                if (!T.helpers.isMobile() && T.$tb && e.parent().get(0) !== T.$tb.get(0)) {
                    var a = e.parent().offset().top, o = t - r - (n || 0);
        ...
        function t(e) {
            var n = A(e), t = n.is(".fr-sticky-on"), r = n.data("sticky-top"), a = n.data("sticky-scheduled");
            if (void 0 === r) {
                n.data("sticky-top", 0);
            ...
            if (T.core.hasFocus() || 0 < T.$tb.findVisible("input:focus").length) {
                ...
                if (s !== r && s !== a && (clearTimeout(n.data("sticky-timeout")), n.data("sticky-scheduled", s), n.outerHeight() < i - T.$tb.parent().offset().top && n.addClass("fr-opacity-0"), n.data("sticky-timeout", setTimeout(function () {
                    ...
                    var l = T.$tb.parent(), c = l.get(0).offsetWidth - l.get(0).clientWidth;
        ...
        function n(e) {
            if (e.offsetWidth) {
                var t = A(e), n = t.outerHeight(), r = t.data("sticky-position"),
                ...
                var s = "body" === T.opts.scrollableContainer ? T.helpers.scrollTop() : o, l = t.is(".fr-sticky-on");
                ...
                var u = T.helpers.getPX(t.data("top")), h = T.helpers.getPX(t.data("bottom")),
                    g = r.top && function b() {
        ...
        function r() {
            if (T.helpers.requestAnimationFrame()(r), !1 !== T.events.trigger("position.refresh")) for (var e = 0; e < T._stickyElements.length; e++) t(T._stickyElements[e])
        }

        function i() {
            if (T._stickyElements) for (var e = 0; e < T._stickyElements.length; e++) n(T._stickyElements[e])
        }
        ...
        return {
            _init: function s() {
                !function e() {
                    T._stickyElements = [], T.helpers.isIOS() ? (r(), T.events.$on(A(T.o_win), "scroll", function () {
                        if (T.core.hasFocus()) for (var e = 0; e < T._stickyElements.length; e++) {
                            var t = A(T._stickyElements[e]), n = t.parent(), r = T.helpers.scrollTop();
                ...
                var t = a();
                e.css({top: 0, left: 0});
                var n = t.top + t.height, r = t.left + t.width / 2 - e.get(0).offsetWidth / 2 + T.helpers.scrollLeft();
            ...
            }, refresh: i, at: o, getBoundingRect: a
        }
            ...
            for (var e = m.$tb.find(".fr-more-toolbar"), c = "", t = 0; t < e.length; t++) {
                ...
                d.hasClass("fr-expanded") ? function () {
                    var n = m.helpers.getPX(d.css("padding-left")), e = d.find("> .fr-command, > .fr-btn-wrap"),
                        ...
                        a = m.helpers.getPX(t.css("margin-right")), o = m.helpers.getPX(t.css("margin-top")),
    ...
    var c = ["scroll", "wheel", "touchmove", "touchstart", "touchend"], d = ["webkit", "moz", "ms", "o"],
        f = ["transitionend"], a = document.createElement("div").style,
        o = ["Webkit", "Moz", "ms", "O", "css", "style"], s = {visibility: "hidden", display: "block"},
        r = ["focus", "blur", "click"], i = {}, l = function l(e, t) {
            return {
                altKey: e.altKey,
                bubbles: e.bubbles,
    ...
    h.fn = h.prototype = {
        constructor: h, length: 0, contains: function (e) {
            ...
            if ("checked" === e) for (var r = 0; r < this.length; r++) this[r].checked = t; else if ("tagName" === e) for (var a = 0; a < this.length; a++) this[a].tagName = t; else for (var o = 0; o < this.length; o++) this[o].setAttribute(e, t);
            return this
            ...
            if ("string" == typeof e) {
                if (0 === this.length) return undefined;
                var r = this[0].ownerDocument || document, a = r.defaultView || r.parentWindow;
            ...
            if (1 < e.split(" ").length) {
                for (var r = e.split(" "), a = 0; a < r.length; a++) if (-1 !== f.indexOf(e)) for (var o = 0; o < d.length; o++) this.on(d[o] + e[0].toUpperCase() + e.slice(1), t, n); else this.on(r[a], t, n);
                return this
            }
            ...
            e = g(e);
            for (var o = 0; o < this.length; o++) if (this[o].querySelectorAll) {
                var i = [];
            ...
            } else for (var a = this.length - 1; 0 <= a; a--) this[a] === e[0] && this.splice(a, 1);
            return this
        }, add: function (e) {
            ...
            if ("string" == typeof e) for (var t = 0; t < this.length; t++) {
                this[t].innerHTML = e;
                for (var n = this[t].children, r = this[t].ownerDocument || document, a = 0; a < n.length; a++) if ("SCRIPT" === n[a].tagName) {
            ...
            if (t) if ("string" == typeof t) for (var n = 0; n < this.length; n++) {
                ...
                var a = this[0];
                if (a.nextSibling) if (t instanceof h) for (var o = 0; o < t.length; o++) a.nextSibling.parentNode.insertBefore(t[o], a.nextSibling); else a.nextSibling.parentNode.insertBefore(t, a.nextSibling); else v(a.parentNode).append(t)
            }
            return this
        }, clone: function (e) {
            ...
            if (t) if ("string" == typeof t) for (var r = 0; r < this.length; r++) {
                ...
                var o = this[0];
                if (o.parentNode) if (t instanceof h) for (var i = 0; i < t.length; i++) o.parentNode.insertBefore(t[i], o); else o.parentNode.insertBefore(t, o)
            }
            return this
        }, append: function (e) {
            if (0 == this.length) return this;
            ...
            } else if (e instanceof h || Array.isArray(e)) for (var a = 0; a < e.length; a++) this.append(e[a]); else "function" != typeof e && this[0].appendChild(e);
            return this
        }, prepend: function (e) {
            if (0 == this.length) return this;
            if ("string" == typeof e) for (var t = 0; t < this.length; t++) {
            ...
            } else if (e instanceof h) for (var a = 0; a < e.length; a++) this.prepend(e[a]); else {
                var o = this[0];
            ...
            if (e && (o += parseInt(v(t).css("marginTop")) + parseInt(v(t).css("marginBottom"))), !r) for (var i in s) t.style[i] = n[i];
            return o
            ...
            if (!r) for (var a in s) n[a] = t.style[a], t.style[a] = s[a];
            var o = t.offsetWidth;
            if (e && (o += parseInt(v(t).css("marginLeft")) + parseInt(v(t).css("marginRight"))), !r) for (var i in s) t.style[i] = n[i];
            return o
        }, width: function (e) {
            ...
            for (var r = 0; r < this.length; r++) for (var a = this[r].parentNode; a && a != document && a.matches && a != e && this[r] != e && ("string" != typeof e || !a.matches(e));) t ? a.matches(t) && n.push(a) : n.push(a), a = a.parentNode;
            return n
        ...
        var r, a, o = 0, i = [];
        if (Array.isArray(e)) for (r = e.length; o < r; o++) null != (a = t(e[o], o, n)) && i.push(a); else for (o in e) null != (a = t(e[o], o, n)) && i.push(a);
    ...
    if (E.Bootstrap = function (e, t, n) {
        ...
        return {
            apply: function i(e) {
                ...
                if (o(t).parents(".fr-img-caption").length) o(t).css("text-align", e); else {
        ...
        html: function () {
            var e = '<ul class="fr-dropdown-list" role="presentation">', t = $e.COMMANDS.align.options;
        ...
        function O(r, e) {
            ...
            e = e || {}, r = (r = r || "").replace(/\r\n|[\r\u2028\u2029]/g, "\n");
            var a = e.indent_size || 4, o = e.indent_char || " ",
            ...
            var C = r.match(/^[\t ]*/)[0], S = new Array(a + 1).join(o), y = 0, R = 0;
            for (var L, w, _ = {
                "{": function (e) {
                ...
                } else if ("/" === d && "/" === g()) D || "{" === M || _.trim(), _.singleSpace(), O.push(E()), _.newLine(); else if ("@" === d) {
        ...
        function a(r, e) {
            var c, a, o, d, i, s, l, f, p, t, n, u, h, g = [], m = "";
            ...
            for (u = {
                TK_START_EXPR: function M() {
                    ...
                    var e, t = function i(e) {
                        ...
                        e.length && n.push(e);
                        return n
                    }(d.text), n = !1, r = !1, a = d.whitespace_before, o = a.length;
            ...
            var b = 0;
            if (r && r.length) {
                for (; " " === r.charAt(b) || "\t" === r.charAt(b);) m += r.charAt(b), b += 1;
                r = r.substring(b)
            }

            function E(e) {
                var t = e.newlines;
                if (h.keep_array_indentation && L(f.mode)) for (var n = 0; n < t; n += 1) A(0 < n); else if (h.max_preserve_newlines && t > h.max_preserve_newlines && (t = h.max_preserve_newlines), h.preserve_newlines && 1 < e.newlines) {
                    A();
            ...
            function T(e) {
                if (e = e !== undefined && e, !c.just_added_newline()) if (h.preserve_newlines && d.wanted_newline || e) A(!1, !0); else if (h.wrap_line_length) {
                    c.current_line.get_character_count() + d.text.length + (c.space_before_token ? 1 : 0) >= h.wrap_line_length && A(!1, !0)
                }
            }

            function A(e, t) {
                if (!t && " " !== f.last_text && "," !== f.last_text && "=" !== f.last_text && "TK_OPERATOR" !== i) for (; f.mode === Z.Statement && !f.if_block && !f.do_block;) _();
        ...
        function Q(t, n) {
            ...
            this.baseIndentString = n, this.indent_string = t, this.previous_line = null, this.current_line = null, this.space_before_token = !1, this.add_outputline = function () {
                ...
                if (!e.multiline_frame && e.mode !== Z.ForInitializer && e.mode !== Z.Conditional) for (var t = e.start_line_index, n = r.length; t < n;) r[t].remove_indent(), t++
        ...
        function ee(_, O, e) {
            var N = "\n\r\t ".split(""), x = /[0-9]/, I = /[01234567]/, k = /[0123456789abcdefABCDEF]/,
                M = "+ - * / % & ++ -- = += -= *= /= %= == === != !== > < >= <= >> << >>> >>>= >>= <<= && &= | || ! ~ , : ? ^ ^= |= :: =>".split(" ");
            ...
            var D, B, F, $, P, H,
                ...
                U = /([\s\S]*?)((?:\*\/)|$)/g, W = /([^\n\r\u2028\u2029]*)/g, V = /\/\* beautify( \w+[:]\w+)+ \*\//g,
                z = / (\w+)[:](\w+)/g, G = /([\s\S]*?)((?:\/\*\sbeautify\signore:end\s\*\/)|$)/g,
                Y = /((<\?php|<\?=)[\s\S]*?\?>)|(<%[\s\S]*?%>)/g;
            ...
            function i() {
                ...
                if (j.isIdentifierStart(_.charCodeAt(P - 1))) {
                    if (P < H) for (; j.isIdentifierChar(_.charCodeAt(P)) && (r += _.charAt(P), (P += 1) !== H);) ;
                ...
                if ("`" === r || "'" === r || '"' === r || ("/" === r || O.e4x && "<" === r && _.slice(P - 1).match(/^<([-a-zA-Z:0-9_.]+|{[^{}]*}|!\[CDATA\[[\s\S]*?\]\])(\s+[-a-zA-Z:0-9_.]+\s*=\s*('[^']*'|"[^"]*"|{.*?}))*\s*(\/?)\s*>/)) && ("TK_RESERVED" === t.type && q(t.text, ["return", "case", "throw", "else", "do", "typeof", "yield"]) || "TK_END_EXPR" === t.type && ")" === t.text && t.parent && "TK_RESERVED" === t.parent.type && q(t.parent.text, ["if", "while", "for"]) || q(t.type, ["TK_COMMENT", "TK_START_EXPR", "TK_START_BLOCK", "TK_END_BLOCK", "TK_OPERATOR", "TK_EQUALS", "TK_EOF", "TK_SEMICOLON", "TK_COMMA"]))) {
                    var f = r, p = !1, u = !1;
                    if (e = r, "/" === f) for (var h = !1; P < H && (p || h || _.charAt(P) !== f) && !j.newline.test(_.charAt(P));) e += _.charAt(P), p ? p = !1 : (p = "\\" === _.charAt(P), "[" === _.charAt(P) ? h = !0 : "]" === _.charAt(P) && (h = !1)), P += 1; else if (O.e4x && "<" === f) {
                        var g = /<(\/?)([-a-zA-Z:0-9_.]+|{[^{}]*}|!\[CDATA\[[\s\S]*?\]\])(\s+[-a-zA-Z:0-9_.]+\s*=\s*('[^']*'|"[^"]*"|{.*?}))*\s*(\/?)\s*>/g,
                            m = _.slice(P - 1), v = g.exec(m);
                        if (v && 0 === v.index) {
                            for (var b = v[2], E = 0; v;) {
                                var T = !!v[1], A = v[2], C = !!v[v.length - 1] || "![CDATA[" === A.slice(0, 8);
                    ...
                    } else for (; P < H && (p || _.charAt(P) !== f && ("`" === f || !j.newline.test(_.charAt(P))));) (p || "`" === f) && j.newline.test(_.charAt(P)) ? ("\r" === _.charAt(P) && "\n" === _.charAt(P + 1) && (P += 1), e += "\n") : e += _.charAt(P), p = p ? ("x" !== _.charAt(P) && "u" !== _.charAt(P) || (u = !0), !1) : "\\" === _.charAt(P), P += 1;
                    if (u && O.unescape_strings && (e = function w(e) {
                        var t, n = !1, r = "", a = 0, o = "", i = 0;
                        for (; n || a < e.length;) if (t = e.charAt(a), a++, n) {
                            if (n = !1, "x" === t) o = e.substr(a, 2), a += 2; else {
                                if ("u" !== t) {
                                    r += "\\" + t;
                                    continue
                                }
                            ...
                            if (34 === i || 39 === i || 92 === i) r += "\\" + String.fromCharCode(i); else {
                                if ("x" === t && 126 < i && i <= 255) return e;
                                r += String.fromCharCode(i)
                            }
                        } else "\\" === t ? n = !0 : r += t;
                        return r
                    }(e)), P < H && _.charAt(P) === f && (e += f, P += 1, "/" === f)) for (; P < H && j.isIdentifierStart(_.charCodeAt(P));) e += _.charAt(P), P += 1;
                    return [e, "TK_STRING"]
                }
                if ("#" === r) {
            ...
            this.tokenize = function () {
                ...
                for (var r = null, a = [], o = []; !t || "TK_EOF" !== t.type;) {
                    for (n = i(), e = new J(n[1], n[0], D, B); "TK_COMMENT" === e.type || "TK_BLOCK_COMMENT" === e.type || "TK_UNKNOWN" === e.type;) "TK_BLOCK_COMMENT" === e.type && (e.directives = n[2]), o.push(e), n = i(), e = new J(n[1], n[0], D, B);
            ...
            run: function x(e, t) {
                ...
                for ((t = t || {}).wrap_line_length !== undefined && 0 !== parseInt(t.wrap_line_length, 10) || t.max_char === undefined || 0 === parseInt(t.max_char, 10) || (t.wrap_line_length = t.max_char), r = t.indent_inner_html !== undefined && t.indent_inner_html, a = t.indent_size === undefined ? 4 : parseInt(t.indent_size, 10), m = t.indent_char === undefined ? " " : t.indent_char, s = t.brace_style === undefined ? "collapse" : t.brace_style, o = 0 === parseInt(t.wrap_line_length, 10) ? 32786 : parseInt(t.wrap_line_length || 250, 10), v = t.unformatted || ["a", "span", "img", "bdo", "em", "strong", "dfn", "code", "samp", "kbd", "const", "cite", "abbr", "acronym", "q", "sub", "sup", "tt", "i", "b", "big", "small", "u", "s", "strike", "font", "ins", "del", "address", "pre"], l = t.preserve_newlines === undefined || t.preserve_newlines, c = l ? isNaN(parseInt(t.max_preserve_newlines, 10)) ? 32786 : parseInt(t.max_preserve_newlines, 10) : 0, b = t.indent_handlebars !== undefined && t.indent_handlebars, E = t.wrap_attributes === undefined ? "auto" : t.wrap_attributes, T = t.wrap_attributes_indent_size === undefined ? a : parseInt(t.wrap_attributes_indent_size, 10) || a, d = t.end_with_newline !== undefined && t.end_with_newline, f = Array.isArray(t.extra_liners) ? t.extra_liners.concat() : "string" == typeof t.extra_liners ? t.extra_liners.split(",") : "head,body,/html".split(","), t.indent_with_tabs && (m = "\t", a = 1), (n = new function _() {
                    return this.pos = 0, this.token = "", this.current_mode = "CONTENT", this.tags = {
                        ...
                        var r = n.exec(this.input), a = r ? r.index : this.input.length;
                        ...
                        var t, n, r = "", a = [], o = "", i = !1, s = !0, l = this.pos, c = this.line_char_count;
                        e = e !== undefined && e;
                        do {
                            if (this.pos >= this.input.length) return e && (this.pos = l, this.line_char_count = c), a.length ? a.join("") : ["", "TK_EOF"];
                            if (r = this.input.charAt(this.pos), this.pos++, this.Utils.in_array(r, this.Utils.whitespace)) i = !0; else {
                    ...
                    switch (n.token_type) {
                        ...
                        case"TK_SCRIPT":
                            if ("" !== n.token_text) {
                                ...
                                var A = n.token_text, C = void 0, S = 1;
        ...
        function r(e) {
            ...
            if (c.core.hasFocus() && (a = !0, c.events.disableBlur(), c.$el.blur()), t = (t = t.replace(/<span class="fr-tmp fr-sm">F<\/span>/, "FROALA-SM")).replace(/<span class="fr-tmp fr-em">F<\/span>/, "FROALA-EM"), c.codeBeautifier && !t.includes("fr-embedly") && (t = c.codeBeautifier.run(t, c.opts.codeBeautifierOptions)), f) {
                ...
                n = t.substring(0, n).length - t.substring(0, t.substring(0, n).lastIndexOf("\n") + 1).length, r = t.substring(0, r).length - t.substring(0, t.substring(0, r).lastIndexOf("\n") + 1).length, f.setSize(null, c.opts.height ? c.opts.height : "auto"), c.opts.heightMin && c.$box.find(".CodeMirror-scroll").css("min-height", c.opts.heightMin), f.setValue(t), v = !a, f.focus(), v = !0, f.setSelection({
                    line: o,
                    ch: n
                }, {line: i, ch: r}), f.refresh(), f.clearHistory()
            } else {
        ...
        function c(e) {
            var t, n = m.popups.get("".concat(e, "Color.picker")), r = v(m.selection.element());
        ...
        return {
            showColorsPopup: function d(e) {
                var t = m.$tb.find('.fr-command[data-cmd="'.concat(e, '"]')), n = m.popups.get("".concat(e, ".picker"));
                if (n || (n = function i(e) {
                    var t = "";
                        ...
                        m.events.on("popup.tab", function (e) {
                            ...
                            if ($e.KEYCODE.TAB === n) {
                                ...
                                if (t.is("span.fr-select-color")) {
                                    var o = t.parent().find("span.fr-select-color"), i = o.index(t),
                                        s = m.opts.colorsStep, l = Math.floor(o.length / s), c = i % s,
                                        d = Math.floor(i / s), f = d * s + c, p = l * s;
                ...
                }(e)), !n.hasClass("fr-active")) if (m.popups.setContainer("".concat(e, ".picker"), m.$tb), c("textColor" === e ? "text" : "background"), t.isVisible()) {
                    var r = m.button.getPosition(t), a = r.left, o = r.top;
                    m.popups.show("".concat(e, ".picker"), a, o, t.outerHeight())
                } else m.position.forSelection(n), m.popups.show("".concat(e, ".picker"))
            }, background: r, customColor: function o(e) {
                var t = m.popups.get("".concat(e, "Color.picker")).find(".fr-color-hex-layer input");
                if (t.length) {
                    var n = t.val();
                    "background" === e ? r(n) : a(n)
                }
            }, text: a, back: function e() {
        ...
        function t(e) {
            e.originalEvent.dataTransfer.dropEffect = "move", d.opts.dragInline ? (!function n() {
                for (var e = null, t = 0; t < $e.INSTANCES.length; t++) if ((e = $e.INSTANCES[t].$el.find(".fr-dragging")).length) return e.get(0)
        ...
        function a(e) {
            var t, n;
            d.$el.attr("contenteditable", !0);
            for (var r = 0; r < $e.INSTANCES.length; r++) if ((t = $e.INSTANCES[r].$el.find(".fr-dragging")).length) {
                n = $e.INSTANCES[r];
                break
            }
            if (t.length) {
                if (e.preventDefault(), e.stopPropagation(), f && f.hasClass("fr-visible") && d.$box.find(f).length) f.data("fr-tag")[f.data("fr-position")]('<span class="fr-marker"></span>'), f.removeClass("fr-visible"); else if (!1 === d.markers.insertAtPoint(e.originalEvent)) return !1;
                if (t.removeClass("fr-dragging"), !1 === (t = d.events.chainTrigger("element.beforeDrop", t))) return !1;
                var a = t;
                if (t.parent().is("A") && 1 === t.parent().get(0).childNodes.length && (a = t.parent()), d.core.isEmpty()) d.events.focus(); else d.$el.find(".fr-marker").replaceWith($e.MARKERS), d.selection.restore();
                if (n === d || d.undo.canDo() || d.undo.saveStep(), d.core.isEmpty()) d.$el.html(a); else {
        ...
        var v = m.$, a = m.opts.emoticonsSet, o = a && a[0], i = "";
            ...
            return "".concat(function r(e, t) {
                return '<div class="fr-buttons fr-tabs fr-tabs-scroll">\n                        '.concat(function n(e, r) {
                    ...
                    return e.forEach(function (e) {
                        var t = {image: e.code.toLowerCase()}, n = {
                ...
                return '\n        <div class="fr-icon-container fr-emoticon-container">\n            '.concat(function t(e) {
                    ...
                    return e.emoticons.forEach(function (e) {
                        ...
                        }, ""), n = {image: e.code.toLowerCase(), compiledCode: e.uCode ? e.uCode : t}, r = {
            ...
            _init: function e() {
                ...
                n(), m.events.on("html.set", n), m.events.on("keydown", function (e) {
                    if (m.keys.isCharacter(e.which) && m.selection.inEditor()) {
                        var t = m.selection.ranges(0), n = s();
                ...
                var n = s(), r = m.selection.ranges(0);
                ...
                if (e || (e = function o() {
                    ...
                    var e = {buttons: i, custom_layer: l()}, t = m.popups.create("emoticons", e);
                    return function n(g) {
                        m.events.on("popup.tab", function (e) {
                            var t = v(e.currentTarget);
                            ...
                            if ($e.KEYCODE.TAB == o) {
                                ...
                                if (t.is("span.fr-emoticon")) {
                                    ...
                                    r = l.index(t);
                                    var c = m.opts.emoticonsStep, d = Math.floor(l.length / c), f = r % c,
                                        p = Math.floor(r / c), u = p * c + f, h = d * c;
                    ...
                    var t = m.$tb.find('.fr-command[data-cmd="emoticons"]'), n = m.button.getPosition(t), r = n.left,
                        a = n.top;
        ...
        return {
            _init: function d() {
                ...
                var e = s(document.createElement("div")).html(a.opts.entities).text(), t = a.opts.entities.split(";");
                i = {}, o = "";
                for (var n = 0; n < e.length; n++) {
                    var r = e.charAt(n);
        ...
        var r, f = d.$, l = "https://i.froala.com/upload", p = 2, u = 3, h = 4, c = 5, g = 6, n = {};
        ...
        function b(e) {
            var t = this.status, n = this.response, r = this.responseXML, a = this.responseText;
            try {
                if (d.opts.fileUploadToS3) if (201 === t) {
                    var o = function s(e) {
                        try {
                            var t = f(e).find("Location").text(), n = f(e).find("Key").text();
                    ...
                    o && v(o, e, n || r)
                } else A(h, n || r); else if (200 <= t && t < 300) {
                    var i = function l(e) {
                        try {
        ...
        return n[1] = "File cannot be loaded from the passed link.", n[p] = "No link in upload response.", n[u] = "Error during file upload.", n[h] = "Parsing response failed.", n[c] = "File is too large.", n[g] = "File file type is invalid.", n[7] = "Files can be uploaded only to same domain in IE 8 and IE 9.", {
            _init: function L() {
                ...
                if (t || (t = S()), o(), !t.hasClass("fr-active")) if (d.popups.refresh("file.insert"), d.popups.setContainer("file.insert", d.$tb), e.isVisible) {
                    var n = d.button.getPosition(e), r = n.left, a = n.top;
                    d.popups.show("file.insert", r, a, e.outerHeight())
                } else d.position.forSelection(t), d.popups.show("file.insert")
            }, upload: i, insert: v, back: function e() {
        ...
        function n() {
            var e = i(o(a.selection.element()).css("font-family")), t = [];
            for (var n in a.opts.fontFamily) if (a.opts.fontFamily.hasOwnProperty(n)) {
                var r = s(e, i(n));
                r && t.push([n, r])
            }
        ...
        function d(e) {
            ...
            t || (t = function o() {
                ...
                var t = {buttons: e}, n = i.popups.create("forms.edit", t);
            ...
            var r = n.offset().left + n.outerWidth() / 2, a = n.offset().top + n.outerHeight();
            i.popups.show("forms.edit", r, a, n.outerHeight())
        }

        function o() {
            var e = i.popups.get("forms.update"), t = c();
            if (t) {
                var n = l(t);
        ...
        return {
            _init: function u() {
                ...
                var e = i.popups.get("forms.update"), t = c();
                if (t) {
                    var n = l(t), r = e.find('input[type="text"][name="text"]').val() || "";
                    r.length && (n.is("button") ? n.text(r) : n.attr("placeholder", r)), i.popups.hide("forms.update"), d(t)
                }
            }, getInput: c, applyStyle: function g(e, t, n) {
        ...
        title: "Style", type: "dropdown", html: function () {
            ...
            var n = this.$, r = this.forms.getInput();
            if (r) {
                var a = n(r);
    ...
    }), $e.DefineIcon("inputEdit", {NAME: "edit"}), $e.RegisterCommand("inputEdit", {
        title: "Edit Button",
        undo: !1,
        refreshAfterCallback: !1,
        callback: function () {
        ...
        function d() {
            ...
            var e = a.$tb.find('.fr-command[data-cmd="moreText"]'),
                ...
                n = a.$tb.find('.fr-command[data-cmd="moreRich"]'), r = a.$tb.find('.fr-command[data-cmd="moreMisc"]');
        ...
        return {
            _init: function e() {
                ...
                if (!r) {
                    var e = "<h4>" + s.language.translate("Shortcuts") + "</h4>", t = function i() {
                        for (var e = '<div class="fr-help-modal">', t = 0; t < s.opts.helpSets.length; t++) {
                            var n = s.opts.helpSets[t], r = "<table>";
        ...
        var p, l, c, d, s, n, u = f.$, i = "https://i.froala.com/upload", t = !1, r = 1, h = 2, g = 3, m = 4, v = 5,
            b = 6, a = {};
        ...
        function S(e) {
            ...
            for (t = 0; t < n.length; t++) if (r.push(n[t].getAttribute("src")), u(n[t]).toggleClass("fr-draggable", f.opts.imageMove), "" === n[t].getAttribute("class") && n[t].removeAttribute("class"), "" === n[t].getAttribute("style") && n[t].removeAttribute("style"), n[t].parentNode && n[t].parentNode.parentNode && f.node.hasClass(n[t].parentNode.parentNode, "fr-img-caption")) {
            ...
            if (s) for (t = 0; t < s.length; t++) r.indexOf(s[t].getAttribute("src")) < 0 && f.events.trigger("image.removed", [u(s[t])]);
            if (s && e) {
                var i = [];
        ...
        function w(e) {
            ...
            if ("mousedown" == e.type) {
                var n = f.$oel.get(0).ownerDocument, r = n.defaultView || n.parentWindow, a = !1;
                try {
        ...
        function _(e) {
            ...
            if (c && p) {
                ...
                if (!n) return !1;
                var r = n - c.data("start-x"), a = c.data("start-width");
        ...
        function I(e) {
            ...
            if (t || (t = Y()), t.find(".fr-layer.fr-active").removeClass("fr-active").addClass("fr-pactive"), t.find(".fr-image-progress-bar-layer").addClass("fr-active"), t.find(".fr-buttons").hide(), p) {
                ...
                var r = n.offset().left, a = n.offset().top + n.height();
        ...
        function P(e) {
            ...
            try {
                if (f.opts.imageUploadToS3) if (201 == t) {
                    var o = function s(e) {
                        try {
                            var t = u(e).find("Location").text(), n = u(e).find("Key").text();
                    ...
                    o && $(o, !1, [], e, n || r)
                } else N(m, n || r, e); else if (200 <= t && t < 300) {
                    var i = function l(e) {
                        try {
        ...
        function U(e, t, n) {
            ...
            if (t && void 0 !== t) for (r in t) t.hasOwnProperty(r) && "link" != r && (" data-" + r + '="' + t[r] + '"', a.attr("data-str" + r, t[r]));
        ...
        function V(e, t) {
            if (void 0 !== e && 0 < e.length) {
                ...
                if (f.drag_support.formdata && (n = f.drag_support.formdata ? new FormData : null), n) {
                    ...
                    f.opts.imageUploadToS3 && (o = f.opts.imageUploadToS3.uploadURL ? f.opts.imageUploadToS3.uploadURL : "https://" + f.opts.imageUploadToS3.region + ".amazonaws.com/" + f.opts.imageUploadToS3.bucket), function l(t, n, e, a) {
                        function o() {
                            var e = u(this);
        ...
        function G(e) {
            ...
            if (t && t.files && t.files.length) {
                ...
                if (n && n.type && -1 !== n.type.indexOf("image") && 0 <= f.opts.imageAllowedTypes.indexOf(n.type.replace(/image\//g, ""))) {
                    ...
                    var a = e.originalEvent.pageX, o = e.originalEvent.pageY;
                    if (f.opts.iframe) {
        ...
        function Y(e) {
            ...
            var o = f.opts.imageInsertButtons.indexOf("imageUpload"),
                i = f.opts.imageInsertButtons.indexOf("imageByURL"), s = "";
        ...
        function re(e) {
            ...
            } else if (e && e.nodeType == Node.ELEMENT_NODE) for (var r = e.querySelectorAll("img.fr-uploading, img.fr-error, img.fr-draggable"), a = 0; a < r.length; a++) re(r[a])
        }
        ...
        function oe() {
            f.opts.imagePaste ? f.$el.find("img[data-fr-image-pasted]").each(function (e, r) {
                ...
                if (0 === r.src.indexOf("data:")) ae(r); else if (0 === r.src.indexOf("blob:") || 0 === r.src.indexOf("http") && f.opts.imageUploadRemoteUrls && f.opts.imageCORSProxy) {
                    var n = new Image;
        ...
        function se(e) {
            if (e && e.clipboardData && e.clipboardData.items) {
                var t = null;
                if (e.clipboardData.types && -1 != [].indexOf.call(e.clipboardData.types, "text/rtf") || e.clipboardData.getData("text/rtf")) t = e.clipboardData.items[0].getAsFile(); else for (var n = 0; n < e.clipboardData.items.length && !(t = e.clipboardData.items[n].getAsFile()); n++) ;
        ...
        return {
            _init: function Ce() {
                ...
                (function e() {
                    ...
                    for (var e = 0; e < r.length; e++) {
                        var t = r[e].style.width || u(r[e]).width(), n = r[e].style.height || u(r[e]).height();
            ...
            showInsertPopup: function Se() {
                ...
                if (t || (t = Y()), k(), !t.hasClass("fr-active")) if (f.popups.refresh("image.insert"), f.popups.setContainer("image.insert", f.$tb), e.isVisible()) {
                    var n = f.button.getPosition(e), r = n.left, a = n.top;
            ...
            insertByURL: function we() {
                ...
                if (0 < e.val().length) {
                    ...
                    if (f.opts.imageUploadRemoteUrls && f.opts.imageCORSProxy && f.opts.imageUpload) {
                        var n = new XMLHttpRequest;
                        n.onload = function () {
                            200 == this.status ? V([new Blob([this.response], {type: this.response.type || "image/png"})], p) : N(r)
                        }, n.onerror = function () {
                            $(t, !0, [], p)
        ...
        html: function () {
            var e = '<ul class="fr-dropdown-list" role="presentation">', t = $e.COMMANDS.imageAlign.options;
        ...
        var l, c, o, i, d, f, p, u, h, g, m, v = s.$, b = "image_manager", e = 10, E = 11, T = 12, A = 13, C = 14,
            S = 15, n = 21, r = 22, a = {};
        ...
        function t(a) {
            ...
            N(!1), o.onload = function () {
                ...
                if (a.thumb) n.attr("src", a.thumb); else {
                    if (M(C, a), !a.url) return M(S, a), !1;
                    n.attr("src", a.url)
                }
                if (a.url && n.attr("data-url", a.url), a.tag) if (c.find(".fr-modal-more.fr-not-available").removeClass("fr-not-available"), c.find(".fr-modal-tags").show(), 0 <= a.tag.indexOf(",")) {
        ...
        function I(e) {
            var t = v(e.currentTarget).siblings("img"), n = l.data("instance") || s, r = l.data("current-image");
            if (s.modals.hide(b), n.image.showProgressBar(), r) r.data("fr-old-src", r.attr("src")), r.trigger("click"); else {
                n.events.focus(!0), n.selection.restore();
                var a = n.position.getBoundingRect(), o = a.left + a.width / 2 + v(s.doc).scrollLeft(),
        ...
        function k(e) {
            ...
            confirm(t) && (s.opts.imageManagerDeleteURL ? !1 !== s.events.trigger("imageManager.beforeDeleteImage", [o]) && (o.parent().addClass("fr-image-deleting"), v(this).ajax({
                ...
                headers: s.opts.requestHeaders,
                    ...
                    o.parent().remove(), O(r), function a() {
        ...
        return a[e] = "Image cannot be loaded from the passed link.", a[E] = "Error during load images request.", a[T] = "Missing imageManagerLoadURL option.", a[A] = "Parsing load response failed.", a[C] = "Missing image thumb.", a[S] = "Missing image URL.", a[n] = "Error during delete image request.", a[r] = "Missing imageManagerDeleteURL option.", {
            require: ["image"], _init: function P() {
                ...
                l.data("current-image", s.image.get()), s.modals.show(b), i || function r() {
                    ...
                    i.show(), d.find(".fr-list-column").empty(), s.opts.imageManagerLoadURL ? v(this).ajax({
                        ...
                        headers: s.opts.requestHeaders,
                            ...
                            s.events.trigger("imageManager.imagesLoaded", [e]), function r(e, t) {
                                try {
    ...
    return $e.DEFAULTS.imageInsertButtons.push("imageManager"), $e.RegisterCommand("imageManager", {
        ...
        return {
            apply: function t(e) {
                ...
                t.find(".fr-command").each(function () {
                    var e = r(this).data("param1"), t = n.format.is("span", {"class": e});
        ...
        return {
            apply: function o(e) {
                if ("" !== a.selection.text()) for (var t = e.split(";"), n = 0; n < t.length; n++) {
                    var r = t[n].split(":");
        ...
        function n(e) {
            ...
            (t = r && ("HTML" == r.tagName || "BODY" == r.tagName || h.node.isElement(r) || 0 <= (r.getAttribute("class") || "").indexOf("fr-line-breaker")) ? ((n = i(e.pageX - h.win.pageXOffset, e.pageY - h.win.pageYOffset, 1)) || (n = d(e.pageX - h.win.pageXOffset - h.opts.lineBreakerHorizontalOffset, e.pageY - h.win.pageYOffset, "left")), n || (n = d(e.pageX - h.win.pageXOffset + h.opts.lineBreakerHorizontalOffset, e.pageY - h.win.pageYOffset, "right")), c(n)) : c(r)) ? function s(e, t) {
                ...
                if (Math.abs(o - t) <= h.opts.lineBreakerOffset || Math.abs(t - a) <= h.opts.lineBreakerOffset) if (Math.abs(o - t) < Math.abs(t - a)) {
        ...
        function u(e) {
            ...
            g.removeClass("fr-visible").removeData("instance");
            var n = g.data("tag1"), r = g.data("tag2"), a = h.html.defaultTag();
        ...
        function h() {
            ...
            var n = p.selection.element(), r = p.selection.endElement();
        ...
        function g() {
            var e, t, n, r, a = p.image ? p.image.get() : null, o = [];
            if (a) "A" == a.get(0).parentNode.tagName && o.push(a.get(0).parentNode); else if (p.win.getSelection) {
                var i = p.win.getSelection();
                if (i.getRangeAt && i.rangeCount) {
                    r = p.doc.createRange();
                    for (var s = 0; s < i.rangeCount; ++s) if ((t = (e = i.getRangeAt(s)).commonAncestorContainer) && 1 != t.nodeType && (t = t.parentNode), t && "a" == t.nodeName.toLowerCase()) o.push(t); else {
            ...
            } else if (p.doc.selection && "Control" != p.doc.selection.type) if ("a" == (t = (e = p.doc.selection.createRange()).parentElement()).nodeName.toLowerCase()) o.push(t); else {
            ...
            if (p.core.hasFocus()) {
                ...
                setTimeout(function () {
                    if (!a || a && (1 == a.which || "mouseup" != a.type)) {
                        var e = h(), t = p.image ? p.image.get() : null;
                        if (e && !t) {
                            if (p.image) {
        ...
        function i(e) {
            ...
            t || (t = function o() {
                ...
                var t = {buttons: e}, n = p.popups.create("link.edit", t);
        ...
        function l() {
            var e = p.popups.get("link.insert"), t = h();
            if (t) {
                var n, r, a = u(t), o = e.find('input.fr-link-attr[type="text"]'),
        ...
        function d() {
            ...
            if (e) {
                ...
                var n = (p.image ? p.image.get() : null) || u(e), r = n.offset().left + n.outerWidth() / 2,
        ...
        return {
            _init: function e() {
                ...
                var e = p.$tb.find('.fr-command[data-cmd="insertLink"]'), t = p.popups.get("link.insert");
                if (t || (t = s()), !t.hasClass("fr-active")) if (p.popups.refresh("link.insert"), p.popups.setContainer("link.insert", p.$tb || p.$sc), e.isVisible()) {
                    var n = p.button.getPosition(e), r = n.left, a = n.top;
                ...
                var t, n, r = p.opts.linkList[e], a = p.popups.get("link.insert"),
                    o = a.find('input.fr-link-attr[type="text"]'), i = a.find('input.fr-link-attr[type="checkbox"]');
                ...
                var e, t, n = p.popups.get("link.insert"), r = n.find('input.fr-link-attr[type="text"]'),
                    a = n.find('input.fr-link-attr[type="checkbox"]'),
                    o = (r.filter('[name="href"]').val() || "").trim(), i = r.filter('[name="text"]').val(), s = {};
            ...
            }, insert: c, update: d, get: h, allSelected: g, back: function t() {
            ...
            }, imageLink: f, applyStyle: function T(e, t, n) {
        ...
        title: "Style", type: "dropdown", html: function () {
            ...
            var n = this.$, r = this.link.get();
            if (r) {
                var a = n(r);
                t.find(".fr-command").each(function () {
                    var e = n(this).data("param1"), t = a.hasClass(e);
                    n(this).toggleClass("fr-active", t).attr("aria-selected", t)
                })
            }
        }, refresh: function (e) {
        ...
        function o(e, t) {
            ...
            var n, r = f.html.defaultTag(), a = null;
            ...
            for (var o = 0; o < e.length; o++) if ("TD" != e[o].tagName && "TH" != e[o].tagName && "LI" != e[o].tagName) {
                ...
                var s = 0 < a ? "<" + t + ' style="' + n + ": " + a + 'px ">' : "<" + t + ">", l = "</" + t + ">";
        ...
        function i(e) {
            var t, n;
            for (t = e.length - 1; 0 <= t; t--) for (n = t - 1; 0 <= n; n--) if (p(e[n]).find(e[t]).length || e[n] == e[t]) {
                e.splice(t, 1);
                break
            }
            var r = [];
            for (t = 0; t < e.length; t++) {
                var a = p(e[t]), o = e[t].parentNode, i = a.attr("class");
                if (a.before(h(o.tagName)), "LI" == o.parentNode.tagName) a.before(h("LI")), a.after(u("LI")); else {
                    var s = "";
                    i && (s += ' class="' + i + '"');
        ...
        function e(e) {
            if ("indent" == e || "outdent" == e) {
                var t = !1, n = f.selection.blocks(), r = [], a = n[0].previousSibling || n[0].parentElement;
                if ("outdent" == e) {
        ...
        return {
            apply: function g(e) {
                ...
                if (n.length) {
                    var r = n[0], a = "N", o = p.html.defaultTag();
                ...
                if (p.opts.paragraphFormatSelection) {
                    ...
                    if (t.length) {
                        var n = t[0], r = "N", a = p.html.defaultTag();
        ...
        return {
            _init: function e() {
                ...
                if (n.length) {
                    var r = l(n[0]);
                    t.find(".fr-command").each(function () {
                        var e = l(this).data("param1"), t = r.hasClass(e);
        ...
        var l = s.$, e = null, c = null, t = !1, d = 1, f = 2, n = {};
        ...
        function r(e) {
            ...
            var r = e, t = s.events.trigger("save.before", [e]);
            if (!1 === t) return !1;
            if ("string" == typeof t && (e = t), s.opts.saveURL) {
                var n = {};
                for (var a in s.opts.saveParams) if (s.opts.saveParams.hasOwnProperty(a)) {
        ...
        var m = g.$, n = g.opts.specialCharactersSets[0], a = g.opts.specialCharactersSets, i = "";
        ...
        return {
            setSpecialCharacterCategory: function r(t) {
                ...
                if (e || (e = function o() {
                    ...
                    var e = {buttons: i, custom_layer: s()}, t = g.popups.create("specialCharacters", e);
                    return function n(h) {
                        g.events.on("popup.tab", function (e) {
                            ...
                            if ($e.KEYCODE.TAB == o) {
                                ...
                                if (t.is("span.fr-icon")) {
                                    ...
                                    r = l.index(t);
                                    var c = Math.floor(l.length / 11), d = r % 11, f = Math.floor(r / 11),
                                        p = 11 * f + d, u = 11 * c;
                    ...
                    var t = g.$tb.find('.fr-command[data-cmd="specialCharacters"]'), n = g.button.getPosition(t),
                        r = n.left, a = n.top;
        ...
        function u() {
            ...
            if (e) {
                ...
                if (t || (t = p()), t) {
                    ...
                    var n = x(e), r = n.left + (n.right - n.left) / 2, a = n.bottom;
        ...
        function s() {
            ...
            if (e) {
                    ...
                    return C.events.$on(C.$wp, "scroll.table-colors", function () {
                        ...
                        C.events.on("popup.tab", function (e) {
                            ...
                            if ($e.KEYCODE.TAB == n) {
                                ...
                                var o = t.parent().find("span.fr-command"), i = o.index(t), s = C.opts.colorsStep,
                                    l = Math.floor(o.length / s), c = i % s, d = Math.floor(i / s), f = d * s + c,
                                    p = l * s;
                                $e.KEYCODE.ARROW_UP == n ? f = ((f - s) % p + p) % p : $e.KEYCODE.ARROW_DOWN == n ? f = (f + s) % p : $e.KEYCODE.ARROW_LEFT == n ? f = ((f - 1) % p + p) % p : $e.KEYCODE.ARROW_RIGHT == n && (f = (f + 1) % p);
                                var u = R(o.get(f));
                ...
                var n = x(e), r = (n.left + n.right) / 2, a = n.bottom;
                !function o() {
                    var e = C.popups.get("table.colors"), t = C.$el.find(".fr-selected-cell").first(),
        ...
        function d(e) {
            ...
            var n = {
                buttons: t, rows_columns: function o() {
                ...
                C.events.$on(e, "focus", "[tabIndex]", function (e) {
                    ...
                    if ($e.KEYCODE.ARROW_UP == r || $e.KEYCODE.ARROW_DOWN == r || $e.KEYCODE.ARROW_LEFT == r || $e.KEYCODE.ARROW_RIGHT == r) {
                        if (t.is("span.fr-table-cell")) {
                            var a = t.parent().find("span.fr-table-cell"), o = a.index(t),
                                i = C.opts.tableInsertMaxSize, s = o % i, l = Math.floor(o / i);
        ...
        function f(e) {
            ...
            for (var a = 1; a <= C.opts.tableInsertMaxSize; a++) for (var o = 0; o <= C.opts.tableInsertMaxSize; o++) {
        ...
        function m(e, t, n) {
            var r, a, o, i, s, l = 0, c = L(n);
            if (e < (t = Math.min(t, c[0].length - 1))) for (a = e; a <= t; a++) if (!(e < a && c[0][a] == c[0][a - 1]) && 1 < (i = Math.min(parseInt(c[0][a].getAttribute("colspan"), 10) || 1, t - e + 1)) && c[0][a] == c[0][a + 1]) for (l = i - 1, r = 1; r < c.length; r++) if (c[r][a] != c[r - 1][a]) {
                for (o = a; o < a + i; o++) if (1 < (s = parseInt(c[r][o].getAttribute("colspan"), 10) || 1) && c[r][o] == c[r][o + 1]) o += l = Math.min(l, s - 1); else if (!(l = Math.max(0, l - 1))) break;
                if (!l) break
            }
        ...
        function v(e, t, n) {
            var r, a, o, i, s, l = 0, c = L(n);
            if (e < (t = Math.min(t, c.length - 1))) for (r = e; r <= t; r++) if (!(e < r && c[r][0] == c[r - 1][0]) && 1 < (i = Math.min(parseInt(c[r][0].getAttribute("rowspan"), 10) || 1, t - e + 1)) && c[r][0] == c[r + 1][0]) for (l = i - 1, a = 1; a < c[0].length; a++) if (c[r][a] != c[r][a - 1]) {
                for (o = r; o < r + i; o++) if (1 < (s = parseInt(c[o][a].getAttribute("rowspan"), 10) || 1) && c[o][a] == c[o + 1][a]) o += l = Math.min(l, s - 1); else if (!(l = Math.max(0, l - 1))) break;
                if (!l) break
            }
        ...
        function b(e, t, n, r, a, o, i) {
            var s, l, c;
            for (s = r; s <= a; s++) for (l = o; l <= i; l++) r < s && e[s][l] == e[s - 1][l] || o < l && e[s][l] == e[s][l - 1] || 1 < (c = parseInt(e[s][l].getAttribute(n), 10) || 1) && (1 < c - t ? e[s][l].setAttribute(n, c - t) : e[s][l].removeAttribute(n))
        }
        ...
        function L(e) {
            ...
            return null == (e = e || null) && 0 < Q().length && (e = J()), e && e.findVisible("tr").not(e.find("> table tr")).each(function (s, e) {
                ...
                t.find("> th, > td").each(function (e, t) {
                    for (var n = R(t), r = parseInt(n.attr("colspan"), 10) || 1, a = parseInt(n.attr("rowspan"), 10) || 1, o = s; o < s + a; o++) for (var i = l; i < l + r; i++) c[o] || (c[o] = []), c[o][i] ? l++ : c[o][i] = t;
                    l += r
                })
            }), c
        }
        ...
        function N(e) {
            var t = C.$el.find(".fr-selected-cell");
            if (0 < t.length) {
                var n, r = e.length, a = 0, o = e[0].length, i = 0;
                for (n = 0; n < t.length; n++) {
                    var s = w(t[n], e), l = _(s.row, s.col, e);
        ...
        function x(e) {
            var t = N(e);
            if (null != t) {
                var n = R(e[t.min_i][t.min_j]), r = R(e[t.min_i][t.max_j]), a = R(e[t.max_i][t.min_j]);
                return {
        ...
        function I(e, t) {
            if (R(e).is(t)) A(), R(e).addClass("fr-selected-cell"); else {
                O(), C.edit.off();
                var n = L(), r = w(e, n), a = w(t, n), o = function u(e, t, n, r, a) {
                    var o, i, s, l, c = e, d = t, f = n, p = r;
                ...
                for (var i = o.min_i; i <= o.max_i; i++) for (var s = o.min_j; s <= o.max_j; s++) R(n[i][s]).addClass("fr-selected-cell")
            }
        }

        function k(e) {
            var t = null, n = R(e.target);
        ...
        function e(e) {
            ...
            if (0 < Q().length && !t && M(), !C.edit.isDisabled() || C.popups.isVisible("table.edit")) if (1 != e.which || 1 == e.which && C.helpers.isMac() && e.ctrlKey) (3 == e.which || 1 == e.which && C.helpers.isMac() && e.ctrlKey) && t && M(); else if (o = !0, t) {
        ...
        function n(e) {
            ...
            if (a || C.$tb.is(e.target) || C.$tb.is(R(e.target).closest(".fr-toolbar")) || (0 < Q().length && C.toolbar.enable(), A()), !(1 != e.which || 1 == e.which && C.helpers.isMac() && e.ctrlKey)) {
                ...
                if (y) {
                    ...
                    C.opts.iframe && (t -= C.$iframe.offset().left), S.data("release-position", t), S.removeData("max-left"), S.removeData("max-right"), function T() {
                        var e = S.data("origin"), t = S.data("release-position");
                        if (e !== t) {
                            var n = S.data("first"), r = S.data("second"), a = S.data("table"), o = a.outerWidth();
                            if (C.undo.canDo() || C.undo.saveStep(), null != n && null != r) {
                                var i, s, l, c = L(a), d = [], f = [], p = [], u = [];
                                for (i = 0; i < c.length; i++) s = R(c[i][n]), l = R(c[i][r]), d[i] = s.outerWidth(), p[i] = l.outerWidth(), f[i] = d[i] / o * 100, u[i] = p[i] / o * 100;
                                for (i = 0; i < c.length; i++) if (s = R(c[i][n]), l = R(c[i][r]), c[i][n] != c[i][r]) {
                                    var h = (f[i] * (d[i] + t - e) / d[i]).toFixed(4);
                                    s.css("width", h + "%"), l.css("width", (f[i] + u[i] - h).toFixed(4) + "%")
                                }
                            } else {
                                var g, m = a.parent(), v = o / m.width() * 100,
        ...
        function K(e, t) {
            var n = R(t), r = n.closest("table"), a = r.parent();
            if (t && "TD" != t.tagName && "TH" != t.tagName && (0 < n.closest("td").length ? t = n.closest("td") : 0 < n.closest("th").length && (t = n.closest("th"))), !t || "TD" != t.tagName && "TH" != t.tagName) S && n.get(0) != S.get(0) && n.parent().get(0) != S.get(0) && C.core.sameInstance(S) && P(); else {
                if (n = R(t), 0 === C.$el.find(n).length) return !1;
                var o = n.offset().left - 1, i = o + n.outerWidth();
                if (Math.abs(e.pageX - o) <= C.opts.tableResizerOffset || Math.abs(i - e.pageX) <= C.opts.tableResizerOffset) {
                    var s, l, c, d, f, p = L(r), u = w(t, p), h = _(u.row, u.col, p), g = r.offset().top,
                        m = r.outerHeight() - 1;
        ...
        function U(e, t) {
            ...
            var n, r = R(t).find("tr").first(), a = e.pageX, o = 0, i = 0;
            if (C.opts.iframe) {
        ...
        function V(e) {
            ...
            C.opts.tableResizer && (!C.popups.areVisible() || C.popups.areVisible() && C.popups.isVisible("table.edit")) && K(e, t), !C.opts.tableInsertHelper || C.popups.areVisible() || C.$tb.hasClass("fr-inline") && C.$tb.isVisible() || function o(e, t) {
                if (0 === Q().length) {
                    var n, r, a;
                    if (t && ("HTML" == t.tagName || "BODY" == t.tagName || C.node.isElement(t))) for (n = 1; n <= C.opts.tableInsertHelperOffset; n++) {
        ...
        function j(e) {
            if (1 < Q().length && o && O(), !1 === o && !1 === a && !1 === y) i && clearTimeout(i), C.edit.isDisabled() && !C.popups.isVisible("table.edit") || (i = setTimeout(V, 30, e)); else if (y) {
                var t = e.pageX - C.win.pageXOffset;
                C.opts.iframe && (t += C.$iframe.offset().left);
                var n = S.data("max-left"), r = S.data("max-right");
        ...
        function X() {
            C.shared.$ti_helper || (C.shared.$ti_helper = R(document.createElement("div")).attr("class", "fr-insert-helper").html('<a class="fr-floating-btn" role="button" tabIndex="-1" title="' + C.language.translate("Insert") + '"><svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg"><path d="M22,16.75 L16.75,16.75 L16.75,22 L15.25,22.000 L15.25,16.75 L10,16.75 L10,15.25 L15.25,15.25 L15.25,10 L16.75,10 L16.75,15.25 L22,15.25 L22,16.75 Z"/></svg></a>'), C.events.bindClick(C.shared.$ti_helper, "a", function () {
                var e = c.data("selected-cell"), t = c.data("position"), n = c.data("instance") || C;
        ...
        return {
            _init: function ee() {
                ...
                if (!C.helpers.isMobile()) {
                    y = a = o = !1, C.events.$on(C.$el, "mousedown", e), C.popups.onShow("image.edit", function () {
                        ...
                        e.shiftKey ? !1 === function i(e) {
                            ...
                            var t = e.which, n = C.selection.blocks();
                        ...
                        if (!1 === function r(e) {
                            if (e.which == $e.KEYCODE.TAB) {
                                var t;
                                if (0 < Q().length) t = C.$el.find(".fr-selected-cell").last(); else {
                ...
                var n, r,
                    a = "<table " + (C.opts.tableDefaultWidth ? 'style="width: ' + C.opts.tableDefaultWidth + ';" ' : "") + 'class="fr-inserted-table"><tbody>',
                    o = 100 / t;
                for (n = 0; n < e; n++) {
            ...
            }, remove: h, insertRow: g, deleteRow: function ne() {
                var e = J();
                if (0 < e.length) {
                    var t, n, r, a = L(), o = N(a);
                    if (null == o) return;
                    if (0 === o.min_i && o.max_i == a.length - 1) h(); else {
                        for (t = o.max_i; t >= o.min_i; t--) {
                            for (r = R(e.find("tr").not(e.find("> table tr")).get(t)), n = 0; n < a[t].length; n++) if (0 === n || a[t][n] != a[t][n - 1]) {
                                var i = R(a[t][n]);
                ...
                if (0 < e.length) {
                    ...
                    var n, f = 100 / d[0].length, p = 100 / (d[0].length + 1);
                ...
                if (0 < e.length) {
                    var t, n, r, a = L(), o = N(a);
                    if (null == o) return;
                    if (0 === o.min_j && o.max_j == a[0].length - 1) h(); else {
                        var i = 0;
                        for (t = 0; t < a.length; t++) for (n = 0; n < a[0].length; n++) (r = R(a[t][n])).hasClass("fr-selected-cell") || (r.data("old-width", r.outerWidth() / e.outerWidth() * 100), (n < o.min_j || n > o.max_j) && (i += r.outerWidth() / e.outerWidth() * 100));
                        for (i /= a.length, n = o.max_j; n >= o.min_j; n--) for (t = 0; t < a.length; t++) if (0 === t || a[t][n] != a[t - 1][n]) if (r = R(a[t][n]), 1 < (parseInt(r.attr("colspan"), 10) || 1)) {
                ...
                if (1 < Q().length && (0 === C.$el.find("th.fr-selected-cell").length || 0 === C.$el.find("td.fr-selected-cell").length)) {
                    ...
                    var e, t, n = N(L());
                    if (null == n) return;
                    var r = C.$el.find(".fr-selected-cell"), a = R(r[0]), o = a.parent().find(".fr-selected-cell"),
                        i = a.closest("table"), s = a.html(), l = 0;
                ...
                if (1 == Q().length) {
                    var e = C.$el.find(".fr-selected-cell"), t = parseInt(e.attr("colspan"), 10) || 1,
                        n = e.parent().outerWidth(), r = e.outerWidth(), a = e.clone().html("<br>"), o = L(),
                        i = w(e.get(0), o);
                    if (1 < t) {
                        var s = Math.ceil(t / 2);
                        ...
                        var c;
                        for (c = 0; c < o.length; c++) if (0 === c || o[c][i.col] != o[c - 1][i.col]) {
                            var d = R(o[c][i.col]);
                            if (!d.is(e)) {
                ...
                if (1 == Q().length) {
                    var e = C.$el.find(".fr-selected-cell"), t = e.parent(), n = e.closest("table"),
                        r = parseInt(e.attr("rowspan"), 10), a = L(), o = w(e.get(0), a), i = e.clone().html("<br>");
                    if (1 < r) {
                        var s = Math.ceil(r / 2);
                        1 < s ? e.attr("rowspan", s) : e.removeAttr("rowspan"), 1 < r - s ? i.attr("rowspan", r - s) : i.removeAttr("rowspan");
                        for (var l = o.row + s, c = 0 === o.col ? o.col : o.col - 1; 0 <= c && (a[l][c] == a[l][c - 1] || 0 < l && a[l][c] == a[l - 1][c]);) c--;
                        -1 == c ? R(n.find("tr").not(n.find("> table tr")).get(l)).prepend(i) : R(a[l][c])[0].parentNode && R(a[l][c])[0].insertAdjacentElement("afterend", i[0])
                    } else {
                        var d, f = R(document.createElement("tr")).append(i);
                        for (d = 0; d < a[0].length; d++) if (0 === d || a[o.row][d] != a[o.row][d - 1]) {
                            var p = R(a[o.row][d]);
                ...
                var e = C.$tb.find('.fr-command[data-cmd="insertTable"]'), t = C.popups.get("table.insert");
                if (t || (t = d()), !t.hasClass("fr-active")) {
                    C.popups.refresh("table.insert"), C.popups.setContainer("table.insert", C.$tb);
                    var n = C.button.getPosition(e), r = n.left, a = n.top;
                    C.popups.show("table.insert", r, a, e.outerHeight())
                }
            }, showEditPopup: u, showColorsPopup: s, back: function fe() {
            ...
            }, selectedTable: J, selectedCells: Q, customColor: function ge() {
        ...
        html: function () {
            var e = '<ul class="fr-dropdown-list" role="presentation">', t = $e.COMMANDS.tableRows.options;
        ...
        html: function () {
            var e = '<ul class="fr-dropdown-list" role="presentation">', t = $e.COMMANDS.tableColumns.options;
        ...
        html: function () {
            var e = '<ul class="fr-dropdown-list" role="presentation">', t = $e.COMMANDS.tableCells.options;
        ...
        title: "Table Style", type: "dropdown", focus: !1, html: function () {
            ...
            var n = this.$, r = this.$el.find(".fr-selected-cell").closest("table");
            r && t.find(".fr-command").each(function () {
                var e = n(this).data("param1"), t = r.hasClass(e);
                n(this).toggleClass("fr-active", t).attr("aria-selected", t)
            })
        ...
        html: function () {
            var e = '<ul class="fr-dropdown-list" role="presentation">', t = $e.COMMANDS.tableCellVerticalAlign.options;
        ...
        refresh: function (e) {
            var t = this.table.selectedCells(), n = this.$;
        ...
        title: "Cell Style", type: "dropdown", focus: !1, html: function () {
            ...
            var n = this.$, r = this.$el.find(".fr-selected-cell").first();
            r && t.find(".fr-command").each(function () {
                var e = n(this).data("param1"), t = r.hasClass(e);
                n(this).toggleClass("fr-active", t).attr("aria-selected", t)
            })
        ...
        function t(e, t, n) {
            ...
            var a = n;
            if (o.opts.linkConvertEmailAddress) o.helpers.isEmail(a) && !/^mailto:.*/i.test(a) && (a = "mailto:" + a); else if (o.helpers.isEmail(a)) return t + n;
        ...
        var s, d, f, p, r, n, h = u.$, l = "https://i.froala.com/upload", g = 2, m = 3, v = 4, c = 5, b = 6, a = {};
        ...
        function o() {
            ...
            if (e || (e = function a() {
                ...
                var t = p.find("iframe, embed, video"), n = t.offset().left + t.outerWidth() / 2,
        ...
        function i(e) {
            ...
            var r, a = "", o = u.opts.videoInsertButtons.indexOf("videoUpload"),
        ...
        function C(s, e, c, d, f) {
            ...
            var p = function p() {
                ...
                if (d) {
                    ...
                    if (void 0 !== c) for (t in c) c.hasOwnProperty(t) && "link" != t && e.find("video").attr("data-" + t, c[t]);
                    ...
                    var r, a = "";
                    if (t && void 0 !== t) for (r in t) t.hasOwnProperty(r) && "link" != r && (a += " data-" + r + '="' + t[r] + '"');
        ...
        function _(e) {
            ...
            var t = this.status, n = this.response, r = this.responseXML, a = this.responseText;
            try {
                if (u.opts.videoUploadToS3) if (201 == t) {
                    var o = function s(e) {
                        try {
                            var t = h(e).find("Location").text(), n = h(e).find("Key").text();
                    ...
                    o && C(o, !1, [], e, n || r)
                } else V(v, n || r); else if (200 <= t && t < 300) {
                    var i = function l(e) {
                        try {
        ...
        function I(e) {
            ...
            if (!t || !n) return !1;
            if ("mousedown" == e.type) {
                var r = u.$oel.get(0).ownerDocument, a = r.defaultView || r.parentWindow, o = !1;
                try {
        ...
        function k(e) {
            ...
            if (d) {
                ...
                var t = e.pageX || (e.originalEvent.touches ? e.originalEvent.touches[0].pageX : null),
                    n = e.pageY || (e.originalEvent.touches ? e.originalEvent.touches[0].pageY : null);
                if (!t || !n) return !1;
                var r = d.data("start-x"), a = d.data("start-y");
                d.data("start-x", t), d.data("start-y", n);
                var o = t - r, i = n - a, s = p.find("iframe, embed, video"), l = s.width(), c = s.height();
        ...
        function F() {
            var e, t = Array.prototype.slice.call(u.el.querySelectorAll("video, .fr-video > *")), n = [];
            ...
            if (r) for (e = 0; e < r.length; e++) n.indexOf(r[e].getAttribute("src")) < 0 && u.events.trigger("video.removed", [h(r[e])]);
            r = t
        }
        ...
        function $() {
            ...
            var e = p.find("iframe, embed, video"), t = 0, n = 0;
        ...
        function z() {
            if (p) {
                var e = u.popups.get("video.size"), t = p.find("iframe, embed, video");
        ...
        function Z(e, t, n) {
            !u.opts.htmlUntouched && u.opts.useClasses ? (e.removeClass("fr-fvl fr-fvr fr-dvb fr-dvi"), e.addClass("fr-fv" + n[0] + " fr-dv" + t[0])) : "inline" == t ? (e.css({display: "inline-block"}), "center" == n ? e.css({"float": "none"}) : "left" == n ? e.css({"float": "left"}) : e.css({"float": "right"})) : (e.css({
                display: "block",
                clear: "both"
        ...
        return a[1] = "Video cannot be loaded from the passed link.", a[g] = "No link in upload response.", a[m] = "Error during file upload.", a[v] = "Parsing response failed.", a[c] = "File is too large.", a[b] = "Video file type is invalid.", a[7] = "Files can be uploaded only to same domain in IE 8 and IE 9.", u.shared.vid_exit_flag = !1, {
            _init: function ee() {
                u.opts.videoResponsive && (u.opts.videoResize = !1), function e() {
                ...
                var e = u.$tb.find('.fr-command[data-cmd="insertVideo"]'), t = u.popups.get("video.insert");
                if (t || (t = i()), y(), !t.hasClass("fr-active")) if (u.popups.refresh("video.insert"), u.popups.setContainer("video.insert", u.$tb), e.isVisible()) {
                    var n = u.button.getPosition(e), r = n.left, a = n.top;
            ...
            }, upload: W, insertByURL: function ie(e) {
                void 0 === e && (e = (u.popups.get("video.insert").find('.fr-video-by-url-layer input[type="text"]').val() || "").trim());
                var t = null;
                if (/^http/.test(e) || (e = "https://" + e), u.helpers.isURL(e)) for (var n = 0; n < $e.VIDEO_PROVIDERS.length; n++) {
            ...
            }, remove: q, hideProgressBar: y, showSizePopup: function ue() {
                ...
                var t = p.offset().left + p.outerWidth() / 2, n = p.offset().top + p.height();
                ...
                if (p) {
                    var n = u.popups.get("video.size"), r = p.find("iframe, embed, video");
        ...
        options: {left: "Align Left", center: "None", right: "Align Right"},
        html: function () {
            var e = '<ul class="fr-dropdown-list" role="presentation">', t = $e.COMMANDS.videoAlign.options;
        ...
        function t(e) {
            ...
            e || (A.opts.wordAllowedStyleProps = []), 0 === a.indexOf("<colgroup>") && (a = "<table>" + a + "</table>"), a = function p(e, t) {
                ...
                var n = (new DOMParser).parseFromString(e, "text/html"), r = n.head, a = n.body, i = function f(e) {
                    var t = {}, n = e.getElementsByTagName("style");
                    if (n.length) {
                        var r = n[0], a = r.innerHTML.match(/[\S ]+\s+{[\s\S]+?}/gi);
                        if (a) for (var o = 0; o < a.length; o++) {
                            var i = a[o], s = i.replace(/([\S ]+\s+){[\s\S]+?}/gi, "$1"),
                    ...
                    return e.nodeType !== Node.ELEMENT_NODE || "V:IMAGEDATA" !== e.tagName && "IMG" !== e.tagName || function c(e, t) {
                        ...
                        if (a) {
                            var o = function l(e) {
                                ...
                                var a = n.join("");
                                return btoa(a)
                            }(a.image_hex), i = "data:" + a.image_type + ";base64," + o;
                ...
                g(a, function (e) {
                    ...
                    if (e.nodeType === Node.ELEMENT_NODE) {
                        if (S(e)) {
                            var t = e.parentNode, n = e.previousSibling, r = function E(e, t, n) {
                                var r = /[0-9a-zA-Z]./gi;
                                var a = !1;
                                var o;
                                var i;
                                ...
                                for (; e;) {
                                    ...
                                    if ((n = n || g) < g) d = E(e, t, g), h += d.el.outerHTML, e = d.currentNode; else {
                                        if (g < n) break;
                    ...
                    if (-1 < e.data.indexOf("[if !supportLineBreakNewLine]")) for (var o = e.nextSibling; o;) (o = e.nextSibling) && C(o), o.data && -1 < o.data.indexOf("[endif]") && (o = null);
                    return C(e), !1
                }), g(a, function (e) {
                    if (e.nodeType === Node.ELEMENT_NODE) {
                        var t = e.tagName;
                ...
                var l = a.outerHTML, c = A.opts.htmlAllowedStyleProps;
            ...
            n.innerHTML = a, A.html.cleanBlankSpaces(n), a = n.innerHTML, a = (a = A.paste.cleanEmptyTagsAndDivs(a)).replace(/\u200b/g, ""), function r() {
                A.modals.hide(s)
        ...
        function b(e, t) {
            ...
            for (var a = ["META", "LINK", "XML", "ST1:", "O:", "W:", "FONT"], o = 0; o < a.length; o++) if (-1 !== n.indexOf(a[o])) return e.innerHTML && (e.outerHTML = e.innerHTML), C(e), !1;
            if ("TD" !== n) {
            ...
            }(e, t), "A" !== n || e.attributes.getNamedItem("href") || e.attributes.getNamedItem("name") || !e.innerHTML || (e.outerHTML = e.innerHTML), "A" == n && e.getAttribute("href") && e.querySelector("img")) for (var m = e.querySelectorAll("span"), v = 0; v < m.length; v++) m[v].innerText || (m[v].outerHTML = m[v].innerHTML);
                    ...
                    return a = e, A.opts.wordPasteModal ? function o() {
                        if (!i) {
                            var e = '<h4><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 74.95 73.23" style="height: 25px; vertical-align: text-bottom; margin-right: 5px; display: inline-block"><defs><style>.a{fill:#2a5699;}.b{fill:#fff;}</style></defs><path class="a" d="M615.15,827.22h5.09V834c9.11.05,18.21-.09,27.32.05a2.93,2.93,0,0,1,3.29,3.25c.14,16.77,0,33.56.09,50.33-.09,1.72.17,3.63-.83,5.15-1.24.89-2.85.78-4.3.84-8.52,0-17,0-25.56,0v6.81h-5.32c-13-2.37-26-4.54-38.94-6.81q0-29.8,0-59.59c13.05-2.28,26.11-4.5,39.17-6.83Z" transform="translate(-575.97 -827.22)"/><path class="b" d="M620.24,836.59h28.1v54.49h-28.1v-6.81h22.14v-3.41H620.24v-4.26h22.14V873.2H620.24v-4.26h22.14v-3.41H620.24v-4.26h22.14v-3.41H620.24v-4.26h22.14v-3.41H620.24V846h22.14v-3.41H620.24Zm-26.67,15c1.62-.09,3.24-.16,4.85-.25,1.13,5.75,2.29,11.49,3.52,17.21,1-5.91,2-11.8,3.06-17.7,1.7-.06,3.41-.15,5.1-.26-1.92,8.25-3.61,16.57-5.71,24.77-1.42.74-3.55,0-5.24.09-1.13-5.64-2.45-11.24-3.47-16.9-1,5.5-2.29,10.95-3.43,16.42q-2.45-.13-4.92-.3c-1.41-7.49-3.07-14.93-4.39-22.44l4.38-.18c.88,5.42,1.87,10.82,2.64,16.25,1.2-5.57,2.43-11.14,3.62-16.71Z" transform="translate(-575.97 -827.22)"/></svg> ' + A.language.translate("Word Paste Detected") + "</h4>",
                                ...
                                }(), n = A.modals.create(s, e, t), r = n.$body;
