...
public class ContextListener implements ServletContextListener {
    ...
    private Map<Integer, Set<String>> notifications = new ConcurrentHashMap<>();
    ...
    public void contextInitialized(ServletContextEvent sce) {
        ...
        sce.getServletContext().setAttribute("notifications", notifications);
    ...
    public void contextDestroyed(ServletContextEvent sce) {
        ...
        sce.getServletContext().removeAttribute("notifications");
