...
public class TextMessageDaoImpl implements TextMessageDao {
    private static final Logger logger = LogManager.getLogger(TextMessageDaoImpl.class);

    private final DBRowMapper<TextMessage> mapper = new TextMessageMapper();
    private final Cao<Integer, TextMessage> cao;
    ...
    public TextMessageDaoImpl(Cao<Integer, TextMessage> cao) {
    ...
    private static class TextMessageMapper implements DBRowMapper<TextMessage> {
        @Override
